...
Procedure FillCheckProcessing(Cancel, CheckedAttributes)
	...
	If OperationKind = Enums.OperationKindsNetting.Netting Then
		...
		If DebitorSumOfAccounting <> CreditorAccountingSum Then
			MessageText = NStr("en='Accounting amount of the ""Settlements with customer"" tabular section is not equal to the accounting amount in the ""Settlements with supplier"" tabular section.';ru='Сумма учета табличной части ""Расчеты с покупателем"", не равна сумме учета по табличной части ""Расчеты с поставщиком""!';vi='Số tiền kế toán của phần bảng ""Hạch toán với khách hàng"", không bằng số tiền kế toán theo phần bảng ""Hạch toán với nhà cung cấp""!'");
	...
	ElsIf OperationKind = Enums.OperationKindsNetting.CustomerDebtAssignment Then
		...
		DebitorSumOfAccounting = Debitor.Total("AccountingAmount");
		MessageText = NStr("en='Accounting amount is not equal to the amount in the ""Settlements with customer"" tabular section.';ru='Сумма учета, не равна сумме учета табличной части ""Расчеты с покупателем""!';vi='Số tiền kế toán không bằng số tiền kế toán của phần bảng ""Hạch toán với khách hàng""!'");
	...
	ElsIf OperationKind = Enums.OperationKindsNetting.DebtAssignmentToVendor Then
		...
		If CreditorAccountingSum <> AccountingAmount Then
			MessageText = NStr("en='Account amount is not equal to amount in the tabular section ""Accounts payable""!';ru='Сумма учета, не равна сумме учета табличной части ""Расчеты с поставщиком""!';vi='Số tiền kế toán không bằng số tiền kế toán của phần bảng ""Hạch toán với nhà cung cấp""!'");
			SmallBusinessServer.ShowMessageAboutError(
				ThisObject,
				MessageText,
				Undefined,
