...
Procedure InitializeDocumentDataManagerial(DocumentRefEnterOpeningBalance, StructureAdditionalProperties) Export
	...
	|	CASE
	|		WHEN Managerial.RecordType = VALUE(Enum.DebitCredit.Dr)
	...
	Query.SetParameter("Ref", DocumentRefEnterOpeningBalance);
	Query.SetParameter("Company", StructureAdditionalProperties.ForPosting.Company);
	Query.SetParameter("Content", NStr("en='Entry of opening balance';ru='Ввод начальных остатков';vi='Nhập số dư đầu'"));
...
Procedure InitializeDocumentDataAdvanceHolderPayments(DocumentRefEnterOpeningBalance, StructureAdditionalProperties) Export
	...
	Query.SetParameter("Ref", DocumentRefEnterOpeningBalance);
	Query.SetParameter("Company", StructureAdditionalProperties.ForPosting.Company);
	Query.SetParameter("AdvanceHolderDebtEmergence", NStr("en='Enter remaining debt of advance holder';ru='Ввод остатков задолженности подотчетника';vi='Nhập số dư công nợ của người nhận tạm ứng'"));
	Query.SetParameter("DebtRepaymentToAdvanceHolder", NStr("en='Enter remaining debt to advance holder';ru='Ввод остатков задолженности перед подотчетником';vi='Nhập số dư nợ phải trả người nhận tạm ứng'"));
...
Procedure InitializeDocumentDataPayrollPayments(DocumentRefEnterOpeningBalance, StructureAdditionalProperties) Export
	...
	Query.SetParameter("Ref", DocumentRefEnterOpeningBalance);
	Query.SetParameter("Company", StructureAdditionalProperties.ForPosting.Company);
	Query.SetParameter("OccurrenceOfObligationsToStaff", NStr("en='Incurrence of liabilities to personnel';ru='Возникновение обязательств перед персоналом';vi='Phát sinh nợ phải trả người lao động'"));
...
Procedure InitializeDocumentDataTaxesSettlements(DocumentRefEnterOpeningBalance, StructureAdditionalProperties) Export
	...
	Query.SetParameter("Ref", DocumentRefEnterOpeningBalance);
	Query.SetParameter("Company", StructureAdditionalProperties.ForPosting.Company);
	Query.SetParameter("TaxAccrual", NStr("en='Enter remaining debt to budget';ru='Ввод остатков задолженности перед бюджетом';vi='Nhập số dư nợ phải trả ngân sách'"));
...
Procedure InitializeDocumentDataAccountsReceivable(DocumentRefEnterOpeningBalance, StructureAdditionalProperties) Export
	...
	Query.SetParameter("Ref", DocumentRefEnterOpeningBalance);
	Query.SetParameter("Company", StructureAdditionalProperties.ForPosting.Company);
	Query.SetParameter("AppearenceOfCustomerLiability", NStr("en='Enter remaining customer debt';ru='Ввод остатков задолженности покупателей';vi='Nhập số dư công nợ của khách hàng'"));
	Query.SetParameter("CustomerObligationsRepayment", NStr("en='Enter advance balance from customers';ru='Ввод остатков авансов от покупателей';vi='Nhập số dư ứng trước từ khách hàng'"));
...
Procedure InitializeDocumentDataAccountsPayable(DocumentRefEnterOpeningBalance, StructureAdditionalProperties) Export
	...
	Query.SetParameter("Ref", DocumentRefEnterOpeningBalance);
	Query.SetParameter("Company", StructureAdditionalProperties.ForPosting.Company);
	Query.SetParameter("AppearenceOfLiabilityToVendor", NStr("en='Enter remaining debt to suppliers';ru='Ввод остатков задолженности поставщикам';vi='Nhập số dư công nợ phải trả nhà cung cấp'"));
	Query.SetParameter("VendorObligationsRepayment", NStr("en='Enter balance of advances to suppliers';ru='Ввод остатков авансов поставщикам';vi='Nhập số dư ứng trước cho nhà cung cấp'"));
...
Procedure InitializeDocumentDataIncomeAndExpensesUndistributed(DocumentRefEnterOpeningBalance, StructureAdditionalProperties) Export
	...
	|	AND DocumentTable.Ref = &Ref
	|	AND DocumentTable.AdvanceFlag
	|	AND NOT(DocumentTable.Contract.IsServiceContract
...
Procedure DocumentDataInitializationCashAssets(DocumentRefEnterOpeningBalance, StructureAdditionalProperties) Export
	...
	Query.SetParameter("Ref", DocumentRefEnterOpeningBalance);
	Query.SetParameter("Company", StructureAdditionalProperties.ForPosting.Company);
	Query.SetParameter("ContentOfAccountingRecord", NStr("en='Enter cash balance';ru='Ввод остатков денежных средств';vi='Nhập số dư bằng tiền'"));
...
Procedure InitializeInventoryDocumentData(DocumentRefEnterOpeningBalance, StructureAdditionalProperties) Export
	...
	Query.SetParameter("ExpediturePosting", NStr("en='Costs capitalization';ru='Оприходование затрат';vi='Ghi tăng chi phí'"));
	Query.SetParameter("InventoryAcceptedReceiving", NStr("en='Inventory capitalization (received)';ru='Оприходование запасов принятых';vi='Ghi tăng vật tư đã tiếp nhận'"));
	Query.SetParameter("TransferredInventoryReceipt", NStr("en='Inventory capitalization (transferred)';ru='Оприходование запасов переданных';vi='Ghi tăng vật tư đã chuyển giao'"));
	Query.SetParameter("InventoryReception", NStr("en='Inventory receipt';ru='Прием запасов';vi='Tiếp nhận vật tư'"));
...
Procedure DataInitializationFixedAssetsDataInitialization(DocumentRefEnterOpeningBalance, StructureAdditionalProperties)
	...
	Query.SetParameter("Ref", DocumentRefEnterOpeningBalance);
	Query.SetParameter("Company", StructureAdditionalProperties.ForPosting.Company);
	Query.SetParameter("FixedAssetAcceptanceForAccounting", NStr("en='Enter opening balance of capital assets';ru='Ввод начальных остатков по внеоборотным активам';vi='Nhập số dư đầu về tài sản dài hạn'"));
	Query.SetParameter("DepreciationAccrual", NStr("en='Enter opening balance for depreciation';ru='Ввод начальных остатков по амортизации';vi='Nhập số dư đầu về khấu hao'"));
