...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not TaxAccounting Then
		...
		Items.Employees.ExtendedTooltip.Title = 
			NStr("en='Accruals and deductions are specified on the corresponding page for each employee individually.';ru='Начисления и удержания указываются на соответствующей странице для каждого сотрудника в отдельности.';vi='Tính lương và giữ lại tiền lương hoặc thuế được chỉ ra trên trang tương ứng cho từng người lao động riêng lẻ.'");
