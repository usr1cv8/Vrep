...
Procedure GenerateInventoryTransferInCells(CurrentDocument, SpreadsheetDocument, TemplateName)
	...
	HeaderText = NStr("en='Inventory transfer between cells No';ru='Перемещение запасов по ячейкам № ';vi='Điều chuyển vật tư theo ô số'") + DocumentHeader.DocumentNumber + NStr("en=' dated ';ru=' от ';vi='ngày'") + Format(DocumentHeader.DocumentDate, "DLF=DD");
	...
	FillStructureSection.Insert("TransferKind", NStr("en='Transfer kind: ';ru='Вид перемещения: ';vi='Dạng điều chuyển:'") + String(DocumentHeader.OperationKind));
	...
	If TotalsSelection.TotalQuantity = 0 Then
		...
		InventoryTransferredCountInWords = NStr("en='Inventory to move is not specified in the document.';ru='В документе не указаны перемещаемые запасы.';vi='Trong chứng từ chưa chỉ ra vật tư điều chuyển.'");
...
"Общим количеством: %3.';vi='Từ ô ""%1"" thu hồi mặt hàng: %2."
"Tổng số lượng: %3.'");
...
"Общим количеством: %3.';vi='Tại ô ""%1"" có mặt hàng: %2."
"Tổng số lượng: %3.'");
...
Procedure AddPrintCommands(PrintCommands) Export
	...
	PrintCommand.Presentation = NStr("en='Inventory movement among bins';ru='Перемещение запасов по ячейкам';vi='Điều chuyển vật tư theo ô'");
