...
Procedure ProcessChangesOnButtonPricesAndCurrenciesEnd(Result, AdditionalParameters) Export
	...
	// Fill in form data.
	PricesAndCurrency = NStr("en='Doc %1 • Beg. %2';ru='Док %1 • Нач. %2';vi='Trả: %1 • Tính: %2'");
...
Procedure FillByBalance(Command)
	...
	If Not ValueIsFilled(Object.StructuralUnit) Then
		...
		Message.Text = NStr("en='Department is not populated.';ru='Не заполнено подразделение!';vi='Chưa điền bộ phận!'");
