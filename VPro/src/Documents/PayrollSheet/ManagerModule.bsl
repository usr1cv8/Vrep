...
Function PrintForm(ObjectsArray, PrintObjects)
	...
	For Each CurrentDocument IN ObjectsArray Do
		...
		Query.SetParameter("Bas", NStr("en='Bas.';ru='Осн.';vi='Cơ sở'"));
		Query.SetParameter("comb", NStr("en='comb.';ru='Совм.';vi='Tương thích'"));
		Query.Text =
		"SELECT
		...
		While Selection.Next() Do
			...
			If ValueIsFilled(Selection.Surname) Then
				Initials = SmallBusinessServer.GetSurnameNamePatronymic(Selection.Surname, Selection.Name, Selection.Patronymic, False);
...
Procedure AddPrintCommands(PrintCommands) Export
	...
	PrintCommand.Presentation = NStr("en='Pay sheet';ru='ПЛАТЕЖНАЯ ВЕДОМОСТЬ';vi='Bảng kê thanh toán'");
