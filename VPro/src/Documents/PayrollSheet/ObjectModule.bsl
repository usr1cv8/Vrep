...
Procedure FillByBalanceAtServer() Export
	...
	ElsIf OperationKind = Enums.OperationKindsPayrollSheet.Advance Then	
		...
		Message.Text = NStr("en='If advance is paid, population according to balance is not provided.';ru='При выплате аванса заполнение по остаткам не предусмотрено!';vi='Khi thanh toán ứng trước, không xem xét điền theo số dư!'");
 		Message.Message();
