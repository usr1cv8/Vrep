...
Function PrintForm(ObjectsArray, PrintObjects, TemplateName)
	...
	For Each CurrentDocument IN ObjectsArray Do
		...
		If TemplateName = "GoodsExpense" Then
			...
			TemplateArea.Parameters.HeaderText = NStr("en='Good expense No. ';vi='Phiếu xuất kho số ';")
													+ DocumentNumber
													+ NStr("en=' from ';vi='  '")
...
Procedure AddPrintCommands(PrintCommands) Export
	...
	PrintCommand.Presentation = NStr("en='Issue slip';ru='Расходный ордер';vi='Phiếu xuất kho'");
