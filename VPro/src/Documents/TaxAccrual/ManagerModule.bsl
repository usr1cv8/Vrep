...
Procedure InitializeDocumentData(DocumentRefTaxAccrual, StructureAdditionalProperties) Export
	...
	Query.SetParameter("RecoveredTax", NStr("en='Tax reimbursed';ru='Возмещен налог';vi='Hoàn trả thuế'"));
	Query.SetParameter("Incomings", NStr("en='Income';ru='Доходы';vi='Thu nhập'")); 
	Query.SetParameter("Expenses", NStr("en='Expenses';ru='Расходы';vi='Chi phí'")); 
