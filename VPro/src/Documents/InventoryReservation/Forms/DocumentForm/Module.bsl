...
Procedure FillByBasis(Command)
	...
	QuestionText = NStr("en='The document will be completely refilled according to ""Customer order""! Continue?';ru='Документ будет полностью перезаполнен по ""Заказу покупателя""! Продолжить выполнение операции?';vi='Chứng từ sẽ được điền lại toàn bộ theo ""Đơn hàng của khách""! Tiếp tục thực hiện thao tác?'");
	Response = Undefined;
