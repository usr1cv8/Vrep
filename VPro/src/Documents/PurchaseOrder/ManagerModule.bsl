...
Function PrintForm(ObjectsArray, PrintObjects)
	...
	While Header.Next() Do
		...
		TemplateArea.Parameters.HeaderText = NStr("en='Purchase order No ';vi='Đơn hàng nhà cung cấp số ';")
												+ DocumentNumber
												+ NStr("en=' from ';vi=''")
		...
		TemplateArea.Parameters.TotalRow = NStr("en='Total titles ';vi='Tổng số ';")
												+ String(Quantity)
												+ NStr("en=', in the amount of ';vi=', với số tiền là ';")
...
Procedure AddPrintCommands(PrintCommands) Export
	...
	PrintCommand.Presentation = NStr("en='Purchase order';ru='Заказ поставщику';vi='Đơn hàng đặt nhà cung cấp'");
