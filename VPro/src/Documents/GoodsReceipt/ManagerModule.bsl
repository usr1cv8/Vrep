...
Function PrintForm(ObjectsArray, PrintObjects, TemplateName)
	...
	For Each CurrentDocument IN ObjectsArray Do
		...
		If TemplateName = "GoodsReceipt" Then
			...
			TemplateArea.Parameters.HeaderText = NStr("en='PURCHASE ORDER RECEIPT # ';vi='PHIẾU NHẬP KHO SỐ ';")
													+ DocumentNumber
													+ NStr("en=' from ';vi='  '")
...
Procedure Print(ObjectsArray, PrintParameters, PrintFormsCollection, PrintObjects, OutputParameters) Export
	...
	If PrintManagement.NeedToPrintTemplate(PrintFormsCollection, "GoodsReceipt") Then
		...
		PrintManagement.OutputSpreadsheetDocumentToCollection(PrintFormsCollection, "GoodsReceipt", NStr("en='Purchase order receipt';vi='Phiếu nhập kho';"), PrintForm(ObjectsArray, PrintObjects, "GoodsReceipt"));
...
Procedure AddPrintCommands(PrintCommands) Export
	...
	PrintCommand.ID = "M4";
	PrintCommand.Presentation = NStr("en='Receipt slip';ru='Приходный ордер';vi='Phiếu nhập kho'");
