...
Function GeneratePriceLabel(LabelStructure)
	...
	Else
		LabelText = LabelText + NStr("en='specify type prices';ru='указать вид цен';vi='chỉ ra dạng giá'");
	EndIf;
...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	DataImportFromExternalSources.OnCreateAtServer(Metadata.Documents.InventoryReceipt.TabularSections.Inventory, DataLoadSettings, ThisObject);
