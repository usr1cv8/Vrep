...
Procedure GenerateTableIncomeAndExpenses(DocumentRefPassWA, StructureAdditionalProperties)
	...
	Query.SetParameter("DepreciationAccrual", NStr("en='Depreciation accrual';ru='Начисление амортизации';vi='Tính khấu hao'"));
	Query.SetParameter("OtherIncome", NStr("en='Other income';ru='Прочие доходы';vi='Thu nhập khác'"));
	Query.SetParameter("OtherExpenses", NStr("en='Other costs (expenses)';ru='Прочих затраты (расходы)';vi='Chi phí khác'"));
...
Procedure GenerateTableFixedAssets(DocumentRefPassWA, StructureAdditionalProperties)
	...
	Query.SetParameter("DepreciationAccrual", NStr("en='Depreciation accrual';ru='Начисление амортизации';vi='Tính khấu hao'"));
	Query.SetParameter("DepreciationDebiting", NStr("en='Depreciation write-off';ru='Списание амортизации';vi='Ghi giảm khấu hao'"));
	Query.SetParameter("WriteOffOfFixedAssetFromAccounting", NStr("en='Property write-off';ru='Списание имущества с учета';vi='Ghi giảm tài sản cố định'"));
