...
Procedure CreatePayment(Command)
	...
	Else
		...
		ListPaymentDocuments.Add("CashReceipt", NStr("en='Petty cash receipt';ru='Поступление в кассу';vi='Phiếu thu'"));
		ListPaymentDocuments.Add("PaymentReceipt", NStr("en='Payment receipt';ru='Поступление на счет';vi='Thu vào tài khoản'"));
		...
		ListPaymentDocuments.ShowChooseItem(New NotifyDescription("CreatePaymentEnd", ThisObject, New Structure("BasisParameters", BasisParameters)),
			NStr("en='Select payment method';ru='Выберете способ оплаты';vi='Chọn phương thức thanh toán'"));
	EndIf;
