...
Procedure GenerateCashOutflowPlanning(SpreadsheetDocument, ObjectsArray, PrintObjects)
	...
	For Each CurrentDocument IN ObjectsArray Do
		...
		Title = NStr("en='Planning of the cash assets outflow # ';ru='Планирование расхода денежных средств № ';vi='Kế hoạch chi tiền số '") + DocumentNumber + NStr("en=' dated ';ru=' от ';vi='  '") + DocumentDate;
		...
		If DocumentData.CAType = Enums.CashAssetTypes.Noncash Then
			...
			FundingSourceDescription = NStr("en='company settlement account No. ';ru='расчетный счет организации № ';vi='tài khoản thanh toán của doanh nghiệp số '") + DocumentData.BANumber;
			
		ElsIf DocumentData.CAType = Enums.CashAssetTypes.Noncash Then
			
			FundingSourceDescription = NStr("en=""Organisation's cash "";ru='касса организации ';vi='quỹ tiền mặt doanh nghiệp'") + DocumentData.PettyCash;
...
Procedure AddPrintCommands(PrintCommands) Export
	...
	PrintCommand.Presentation = NStr("en='Cash expense planning';ru='Планирование расходов ДС';vi='Kế hoạch chi tiền'");
