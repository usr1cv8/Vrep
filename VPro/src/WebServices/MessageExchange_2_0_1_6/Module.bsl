...
Function CheckConnectionAtSender(SenderCode)
	...
	If MessageExchangeInternal.ThisNodeCode() <> SenderCode Then
		...
		Raise NStr("en='Receiver base connection settings indicate another sender.';ru='Настройки подключения базы получателя указывают на другого отправителя.';vi='Tùy chỉnh kết nối cơ sở nơi nhận chỉ ra cho nơi gửi khác.'");
