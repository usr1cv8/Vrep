...
Procedure RefreshWorkingPlaceParameters()
	...
	If IsBlankString(Title) Then
		Title = NStr("en='Connect and install equipment for work place';ru='Подключение и настройка оборудования для РМ';vi='Kết nối và tùy chỉnh thiết bị đối với quầy thu ngân'") + " """
