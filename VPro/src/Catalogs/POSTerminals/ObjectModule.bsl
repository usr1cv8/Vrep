	...
	If TypeOf(PettyCash) = Type("CatalogRef.CashRegisters") Then
		...
		If ValueIsFilled(Company)
		   ...
		   AND Company <> Attributes.Company Then
			...
			Text = NStr("en='The company of the cash funds does not correspond to the company of the acquiring contract.';ru='Организация кассы не соответствует организации договора эквайринга';vi='Doanh nghiệp của quầy thu ngân không tương ứng với doanh nghiệp trong hợp đồng thanh toán thẻ'");
