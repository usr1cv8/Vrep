...
Procedure BeforeWrite(Cancel, WriteParameters)
	...
	If TrimAll(Object.Description)="" Then
		...
		Message = New UserMessage();
		Message.Text = NStr("en='Serial number is not filled!';ru='Серийный номер не заполнен!';vi='Chưa điền số sê-ri!'");
		Message.Message();
	EndIf; 
...
Procedure AddAdditionalAttribute(Command)
	...
	FormParameters.Insert("CurrentSetOfProperties", PredefinedValue("Catalog.AdditionalAttributesAndInformationSets.Catalog_SerialNumbers"));
