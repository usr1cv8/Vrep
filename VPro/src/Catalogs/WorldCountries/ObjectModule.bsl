...
Function ExistingItem() Export
	...
	If Selection.Next() Then
		Result = New Structure("ErrorDescription", StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en='Code %1 is already assigned to country %2. Enter another code, or use the existing data.';ru='С кодом %1 уже существует страна %2. Измените код или используйте уже существующие данные.';vi='Đã có quốc gia %2 với mã %1. Hãy thay đổi mã hoặc sử dụng dữ liệu sẵn có.'"), 
