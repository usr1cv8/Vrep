...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Parameters.ChoiceMode Then
		...
		If Parameters.CloseOnChoice = False Then
			...
			Title = NStr("en='Select access group profiles';ru='Подбор профилей групп доступа';vi='Chọn hồ sơ nhóm truy cập'");
		Else
			Title = NStr("en='Select an access group profile';ru='Выбор профиля групп доступа';vi='Chọn hồ sơ nhóm truy cập'");
		EndIf;
	EndIf;
