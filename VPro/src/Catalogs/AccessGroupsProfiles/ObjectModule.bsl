...
"Поставляемый профиль уже существует:';vi='Lỗi khi ghi lại hồ sơ ""%1""."
"Đã có hồ sơ thiết lập.'"),
				Description);
...
"Идентификатор поставляемых данных ""%2"" уже используется в профиле:';vi='Lỗi khi ghi lại hồ sơ ""%1""."
"Tên định danh dữ liệu ""%2"" đã được sử dụng trong hồ sơ:'"),
				Description,
			...
			Else
				WriteLogEvent(
					NStr("en='Access management.Violation of unambiguity of the supplied profile';ru='Управление доступом.Нарушение однозначности поставляемого профиля';vi='Quản lý truy cập. Vi phạm sự đồng nhất của hồ sơ có sẵn'",
