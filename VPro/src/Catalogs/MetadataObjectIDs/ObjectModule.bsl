...
"реквизита ""Пометка удаления"" установлено Ложь недопустимо.';vi='Xóa tên của đối tượng metadata, trong đó giá trị mục tin"
"""Đặt dấu xóa"" đã được thiết lập False không được phép.'"));
	EndIf;
