...
Procedure ExecuteDataRefreshing(HasChanges, HasDeleted, CheckOnly = False,
	...
	Try
		...
		If ValueIsFilled(MetadataObjectsRenamingsList) Then
			CriticalChangesList = NStr("en='Rename IDs of metadata objects OldFullName -> NewFullName:';ru='Переименование идентификаторов объектов метаданных СтароеПолноеИмя -> НовоеПолноеИмя:';vi='Đổi Tên định danh đối tượng metadata OldFullName -> NewFullName:'")
		...
		If ValueIsFilled(ListOfNewMetadataObjects) Then
			CriticalChangesList = CriticalChangesList
				+ NStr("en='Add new metadata object identifiers:';ru='Добавление новых идентификаторов объектов метаданных:';vi='Thêm Tên định danh mới của đối tượng metadata:'")
		...
		If ValueIsFilled(CriticalChangesList) Then
			WriteLogEvent(
				NStr("en='Metadata object IDs.Critical changes made';ru='Идентификаторы объектов метаданных.Выполнены критичные изменения';vi='Tên định danh đối tượng Metadata. Đã thực hiện các thay đổi quan trọng'",
...
"""%1"".';vi='Lỗi kết nhập Tên định danh đối tượng metadata."
"Không thể kết nhập phần tử mới mà trong đó không chỉ ra tham chiếu mới:"
"""%1"".'"),
						Object.FullName);
				EndIf;
			EndIf;
...
"которых совпадает полное имя: ""%1"".';vi='Lỗi kết nhập tên (ID) đối tượng metadata."
"Không thể kết nhập hai phần tử của nó"
"trùng tên đầy đủ: ""%1"".'"),
					Object.FullName);
			EndIf;
...
"совпадает ключ объекта метаданных: ""%1"".';vi='Lỗi kết nhập tên (ID) đối tượng metadata."
"Không thể kết nhập hai phần tử mà trong đó"
"trùng khóa đối tượng metadata: ""%1"".'"),
...
"""%1"" не соответствует полному имени ""%2"".';vi='Lỗi kết nhập Tên định danh đối tượng metadata."
"Không thể kết nhập phần tử mà có khóa đối tượng metadata"
"""%1"" không tương ứng với tên đầy đủ ""%2"".'"),
...
Procedure CheckUse() Export
	...
	If StandardSubsystemsReUse.DisableCatalogMetadataObjectIDs() Then
		Raise
			NStr("en='The ""Metadata object IDs"" catalog is not used.';ru='Справочник ""Идентификаторы объектов метаданных"" не используется.';vi='Không sử dụng danh mục ""Tên định danh đối tượng Metadata"".'");
	EndIf;
...
"главным узлом запустите 1C:Предприятие и нажмите кнопку Отключить или программно очистите константу Главный узел.';vi='Danh mục ""Tên (ID) đối tượng"
"metadata"" không thể được sử dụng trong cơ sở thông tin đã hủy nút chính mà chưa được xác nhận."
""
"Để phục hồi kết nối với nút chính,"
"hãy khởi động 1C:DOANH NGHIỆP và nhấn nút Phục hồi"
"hoặc thiết lập nút chính đã lưu trong hằng Nút chính của chương trình."
""
"Để xác nhận hủy kết nối với nút chính, hãy khởi động 1C:DOANH NGHIỆP và nhấn nút Ngắt bỏ hoặc xóa hằng Nút chính trong chương trình.'");
	EndIf;
...
Function MetadataObjectCollectionProperties() Export
	...
	String.Synonym         = NStr("en='Constants';ru='Константы';vi='Hằng'");
	String.SingularName     = "Constant";
	String.SynonymInSingularNumber = NStr("en='Constant';ru='Константа';vi='Hằng'");
	
	// Subsystems
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "cdf5ac50-08e8-46af-9a80-4e63fd4a88ff";
	String.Name             = "Subsystems";
	String.Synonym         = NStr("en='Subsystems';ru='Подсистемы';vi='Phân hệ'");
	String.SingularName     = "Subsystem";
	String.SynonymInSingularNumber = NStr("en='Subsystem';ru='Подсистема';vi='Phân hệ'");
	...
	String.Name             = "Roles";
	String.Synonym         = NStr("en='Roles';ru='Роли';vi='Vai trò'");
	String.SingularName     = "Role";
	String.SynonymInSingularNumber = NStr("en='Role';ru='Роль';vi='Vai trò'");
	String.WithoutData       = True;
	String.WithoutMetadataObjectKey = True;
	...
	String.Synonym         = NStr("en='Exchange plans';ru='Планы обмена';vi='Sơ đồ trao đổi'");
	String.SingularName     = "ExchangePlan";
	String.SynonymInSingularNumber = NStr("en='Exchange plan';ru='План обмена';vi='Sơ đồ trao đổi'");
	
	// Catalogs
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "ede89702-30f5-4a2a-8e81-c3a823b7e161";
	String.Name             = "Catalogs";
	String.Synonym         = NStr("en='Catalogs';ru='Справочники';vi='Danh mục'");
	String.SingularName     = "Catalog";
	String.SynonymInSingularNumber = NStr("en='Catalog';ru='Справочник';vi='Danh mục'");
	
	// Documents
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "96c6ab56-0375-40d5-99a2-b83efa3dac8b";
	String.Name             = "Documents";
	String.Synonym         = NStr("en='Documents';ru='Документы';vi='Chứng từ'");
	String.SingularName     = "Document";
	String.SynonymInSingularNumber = NStr("en='Document';ru='документ';vi='chứng từ'");
	
	// DocumentJournals
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "07938234-e29b-4cff-961a-9af07a4c6185";
	String.Name             = "DocumentJournals";
	String.Synonym         = NStr("en='Document logs';ru='Журналы документов';vi='Nhật ký chứng từ'");
	String.SingularName     = "DocumentJournal";
	String.SynonymInSingularNumber = NStr("en='Document journal';ru='Журнал документов';vi='Nhật ký chứng từ'");
	String.WithoutData       = True;
	...
	String.Name             = "Reports";
	String.Synonym         = NStr("en='Reports';ru='Отчеты';vi='Báo cáo CRM'");
	String.SingularName     = "Report";
	String.SynonymInSingularNumber = NStr("en='Report';ru='Отчет';vi='Báo cáo'");
	String.WithoutData       = True;
	...
	String.Synonym         = NStr("en='Data processors';ru='Обработки';vi='Bộ xử lý'");
	String.SingularName     = "DataProcessor";
	String.SynonymInSingularNumber = NStr("en='Processing';ru='Обработка';vi='Bộ xử lý'");
	String.WithoutData       = True;
	...
	String.Synonym         = NStr("en='Charts of characteristic types';ru='Планы видов характеристик';vi='Hệ thống dạng đặc tính'");
	String.SingularName     = "ChartOfCharacteristicTypes";
	String.SynonymInSingularNumber = NStr("en='Chart of characteristic types';ru='План видов характеристик';vi='Hệ thống dạng đặc tính'");
	
	// ChartsOfAccounts
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "4295af27-543f-4373-bcfc-c0ace9b7620c";
	String.Name             = "ChartsOfAccounts";
	String.Synonym         = NStr("en='Charts of accounts';ru='Планы счетов';vi='Hệ thống tài khoản'");
	String.SingularName     = "ChartOfAccounts";
	String.SynonymInSingularNumber = NStr("en='Chart of accounts';ru='План счетов';vi='Hệ thống tài khoản'");
	
	// ChartsOfCalculationTypes
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "fca3e7e1-1bf1-49c8-9921-aafb4e787c75";
	String.Name             = "ChartsOfCalculationTypes";
	String.Synonym         = NStr("en='Charts of calculation types';ru='Планы видов расчета';vi='Hệ thống dạng tính toán'");
	String.SingularName     = "ChartOfCalculationTypes";
	String.SynonymInSingularNumber = NStr("en='Chart of calculation types';ru='План видов расчета';vi='Hệ thống dạng tính toán'");
	
	// InformationRegisters
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "d7ecc1e9-c068-44dd-83c2-1323ec52dbbb";
	String.Name             = "InformationRegisters";
	String.Synonym         = NStr("en='Information registers';ru='Регистры сведений';vi='Biểu ghi thông tin'");
	String.SingularName     = "InformationRegister";
	String.SynonymInSingularNumber = NStr("en='Information register';ru='Регистр сведений';vi='Biểu ghi thông tin'");
	
	// AccumulationRegisters
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "74083488-b01e-4441-84a6-c386ce88cdb5";
	String.Name             = "AccumulationRegisters";
	String.Synonym         = NStr("en='Accumulation registers';ru='Регистры накопления';vi='Biểu ghi tích lũy'");
	String.SingularName     = "AccumulationRegister";
	String.SynonymInSingularNumber = NStr("en='Accumulation register';ru='Регистр накопления';vi='Biểu ghi tích lũy'");
	
	// AccountingRegisters
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "9a0d75ff-0eda-454e-b2b7-d2412ffdff18";
	String.Name             = "AccountingRegisters";
	String.Synonym         = NStr("en='Accounting registers';ru='Регистры бухгалтерии';vi='Biểu ghi kế toán'");
	String.SingularName     = "AccountingRegister";
	String.SynonymInSingularNumber = NStr("en='Accounting register';ru='Регистр бухгалтерии';vi='Biểu ghi kế toán'");
	
	// CalculationRegisters
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "f330686a-0acf-4e26-9cda-108f1404687d";
	String.Name             = "CalculationRegisters";
	String.Synonym         = NStr("en='Calculation registers';ru='Регистры расчета';vi='Biểu ghi tính toán'");
	String.SingularName     = "CalculationRegister";
	String.SynonymInSingularNumber = NStr("en='Calculation register';ru='Регистр расчета';vi='Biểu ghi tính toán'");
	
	// BusinessProcesses
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "a8cdd0e0-c27f-4bf0-9718-10ec054dc468";
	String.Name             = "BusinessProcesses";
	String.Synonym         = NStr("en='Business processes';ru='Деловые процессы';vi='Quy trình nghiệp vụ'");
	String.SingularName     = "BusinessProcess";
	String.SynonymInSingularNumber = NStr("en='Business process';ru='Бизнес-процесс';vi='Quy trình nghiệp vụ'");
	
	// Tasks
	String = MetadataObjectCollectionProperties.Add();
	String.ID   = "8d9153ad-7cea-4e25-9542-a557ee59fd16";
	String.Name             = "Tasks";
	String.Synonym         = NStr("en='Tasks';ru='Задания';vi='Nhiệm vụ'");
	String.SingularName     = "Task";
	String.SynonymInSingularNumber = NStr("en='Task';ru='Задача';vi='Nhiệm vụ'");
...
"идентификатора объекта метаданных возможно только автоматически при обновлении данных справочника.';vi='Chỉ có thể tạo mới"
"tên (ID) đối tượng metadata một cách tự động khi cập nhật dữ liệu danh mục.'"),
				Object.FullName));
...
"""%1"", которое может быть установлено только автоматически при обновлении данных справочника.';vi='Khi thay đổi tên (ID) đối tượng"
"metadata đã chỉ ra tên đầy đủ"
"""%1"" mà có thể thiết lập tự động khi cập nhật dữ liệu danh mục.'"),
				Object.FullName));
...
"может быть выполнено только в главном узле распределенной информационной базы.';vi='Chỉ có thể thêm mới phần tử"
"tại nút chính của cơ sở thông tin phân tán.'"),
				Object.FullName));
...
"имя"" может быть выполнено только в главном узле распределенной информационной базы.';vi='Chỉ có thể thay đổi"
"mục tin ""Tên đầy đủ'''' trong nút chính của cơ sở thông tin phân tán'"));
			EndIf;
		EndIf;
	EndIf;
...
Procedure CallExceptionByError(ErrorText) Export
	...
	Raise
		NStr("en='An error occurred while working with the ""Metadata object IDs"" catalog.';ru='Ошибка при работе со справочником ""Идентификаторы объектов метаданных"".';vi='Lỗi khi làm việc với danh mục ""Tên đối tượng metadata"".'") + "
		           |
		           |" + ErrorText;
...
"Не следует называть подсистемы одинаково, либо использовать более новую версию платформы.';vi='Lỗi khi tìm kiếm phân hệ theo tên đầy đủ (khi tìm kiếm ""%1"", đã tìm thấy ""%2"")."
"Không nên gọi ra các phân hệ giống nhau, hoặc sử dụng phiên bản nền tảng mới hơn.'"),
				FullName,
				MetadataObject.FullName());
		Else
			Raise StringFunctionsClientServer.SubstituteParametersInString(
				NStr("en='An error occurred when searching for metadata object by full name (searched for ""%1"", ""%2"" was found).';ru='Ошибка при поиске объекта метаданных по полному имени (при поиске ""%1"" был найден ""%2"").';vi='Lỗi khi tìm kiếm đối tượng metadata theo tên đầy đủ (khi tìm kiếm ""%1"" đã tìm thấy ""%2"").'"),
				FullName,
				MetadataObject.FullName());
		EndIf;
	EndIf;
	...
	Try
		For Each TableRow IN RefsTable Do
			...
			ElsIf Metadata.InformationRegisters.Contains(TableRow.Metadata) Then
				...
				EndTry;
			Else
				ShowMessageAboutError(NStr("en='Values are not changed in the type data';ru='Значения не заменяются в данных типа';vi='Giá trị không được thay thế trong dữ liệu kiểu'") + ": " + TableRow.Metadata);
			EndIf;
		EndDo;
...
Procedure ShowMessageAboutError(Val Definition)
	...
	WriteLogEvent(
		NStr("en='Metadata objects IDs. Change identifier';ru='Идентификаторы объектов метаданных. Замена идентификатора';vi='Tên định danh đối tượng Metadata. Thay thế tên'",
		     CommonUseClientServer.MainLanguageCode()),
		EventLogLevel.Error,
		,
		,
