...
Function SuppliedApllicationSettings(OnlyForInitialFill = False) Export
	...
	Setting.Presentation       = NStr("en='ViPNet CSP';ru='ViPNet CSP';vi='ViPNet CSP'");
	...
	// CryptoPro CSP
	Setting = Settings.Add();
	Setting.Presentation       = NStr("en='CSP CryptoPro';ru='КриптоПро CSP';vi='КриптоПро CSP'");
	...
	// LISSI CSP
	Setting = Settings.Add();
	Setting.Presentation       = NStr("en='LISSI CSP';ru='ЛИССИ CSP';vi='LISSI CSP'");
	...
	Setting = Settings.Add();
	Setting.Presentation       = NStr("en='Signal-COM CSP (RFC 4357)';ru='Сигнал-КОМ CSP (RFC 4357)';vi='Signal-КОМ CSP (RFC 4357)'");
	...
	Setting = Settings.Add();
	Setting.Presentation       = NStr("en='Signal-COM CSP (ITU-T X.509 v.3)';ru='Сигнал-КОМ CSP (ITU-T X.509 v.3)';vi='Signal-КОМ CSP (ITU-T X.509 v.3)'");
	...
	Setting = Settings.Add();
	Setting.Presentation       = NStr("en='Microsoft Enhanced CSP';ru='Microsoft Enhanced CSP';vi='Microsoft Enhanced CSP'");
