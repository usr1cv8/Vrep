...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	EndDo;
	Items.Description.ChoiceList.Add("", NStr("en='<Another application>';ru='<Другая программа>';vi='<Chương trình khác>'"));
...
Procedure FillCheckProcessingAtServer(Cancel, CheckedAttributes)
	...
	If Not Query.Execute().IsEmpty() Then
		...
		CommonUseClientServer.MessageToUser(
			NStr("en='Application with the specified name and type has already been added to the list.';ru='Программа с указанным именем и типом уже добавлена в список.';vi='Chương trình với tên và kiểu này đã được thêm vào danh sách.'"),
			,
...
"Записать данные?';vi='Để đặt dấu xóa cần ghi lại những thay đổi bởi bạn."
"Ghi lại dữ liệu?'"), QuestionDialogMode.YesNo);
