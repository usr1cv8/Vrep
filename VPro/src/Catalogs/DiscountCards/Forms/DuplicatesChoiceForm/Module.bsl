...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	ThisForm.Title =  NStr("en='Duplicate list according to barcode (magnetic code) and card kind';ru='Список дублей по штрихкоду (магнитному коду) и виду карты';vi='Danh sách trùng theo mã vạch (thẻ từ) và dạng thẻ'");
