...
Procedure DeleteScheduledJob(Cancel)
	...
	If ScheduledJobObject <> Undefined Then
		...
		Except
			MessageString = NStr("en='An error occurred when removing scheduled job: %1';ru='Ошибка при удалении регламентного задания: %1';vi='Lỗi khi xóa bỏ nhiệm vụ thường kỳ: %1'");
