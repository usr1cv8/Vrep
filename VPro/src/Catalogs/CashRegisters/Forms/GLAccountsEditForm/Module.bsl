...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If CancelGLAccountChange(Ref) Then
		Items.GLAccountsGroup.ToolTip = NStr("en='Records are registered for this cash register in the infobase. Cannot change the GL account.';ru='В базе есть движения по этой кассе ККМ! Изменение счета учета запрещено!';vi='Trong cơ sở có bản ghi kết chuyển theo quầy thu ngân này! Cấm thay đổi tài khoản kế toán!'");
