...
Procedure ListBeforeAddRow(Item, Cancel, Copy, Parent, Group)
	...
	If Copy AND Group Then
		...
		ShowMessageBox(, NStr("en='Adding new groups to the catalog is prohibited.';ru='Добавление новых групп в справочнике запрещено.';vi='Cấm thêm nhóm mới trong danh mục.'"));
	EndIf;
