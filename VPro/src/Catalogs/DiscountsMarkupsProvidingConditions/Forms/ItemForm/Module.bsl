...
Function FormAutoNamingAtClient()
	...
	If Object.AssignmentCondition = PredefinedValue("Enum.DiscountsMarkupsProvidingConditions.ForOneTimeSalesVolume") Then
		...
		?(Object.RestrictionArea = PredefinedValue("Enum.DiscountMarkupRestrictionAreasVariants.InDocument"),NStr("en='in document';ru='в документе';vi='trong chứng từ'"),NStr("en='In line';ru='в строке';vi='trong dòng'")) + " "+Object.ComparisonType + " "+Object.RestrictionConditionValue + 
		?(Object.UseRestrictionCriterionForSalesVolume = PredefinedValue("Enum.DiscountMarkupUseLimitCriteriaForSalesVolume.Quantity"), NStr("en=' unit';ru=' ед';vi=' đvt'"), " "+Object.RestrictionCurrency);
	...
	ElsIf Object.AssignmentCondition = PredefinedValue("Enum.DiscountsMarkupsProvidingConditions.ForKitPurchase") Then
		DescriptionString = NStr("en='Set:';ru='Комплект:';vi='Bộ (gói):'");
...
Function FormAutoNamingAtServer()
	...
	If Object.AssignmentCondition = Enums.DiscountsMarkupsProvidingConditions.ForOneTimeSalesVolume Then
		...
		?(Object.RestrictionArea = Enums.DiscountMarkupRestrictionAreasVariants.InDocument,NStr("en='in document';ru='в документе';vi='trong chứng từ'"),NStr("en='In line';ru='в строке';vi='trong dòng'")) + " "+Object.ComparisonType + " "+Object.RestrictionConditionValue + 
		?(Object.UseRestrictionCriterionForSalesVolume = Enums.DiscountMarkupUseLimitCriteriaForSalesVolume.Quantity, NStr("en=' unit';ru=' ед';vi=' đvt'"), " "+Object.RestrictionCurrency);
		If Object.SalesFilterByProductsAndServices.Count() > 0 Then
