...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If CancelGLAccountChange(Ref) Then
		Items.GLAccountsGroup.ToolTip = NStr("en='Records are registered for these products and services in the infobase. Cannot change the GL account.';ru='В базе есть движения по этой номенклатуре! Изменение счета учета запрещено!';vi='Trong cơ sở có bản ghi kết chuyển theo mặt hàng này! Cấm thay đổi tài khoản kế toán!'");
