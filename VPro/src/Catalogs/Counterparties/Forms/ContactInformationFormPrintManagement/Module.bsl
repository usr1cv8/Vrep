...
"Сохранить изменения?';vi='Thành phần thông tin liên hệ đã bị thay đổi."
"Lưu lại thay đổi?'");
		
		Notification = New NotifyDescription("BeforeCloseSaveOffered", ThisForm);
		ShowQueryBox(Notification, QuestionText, QuestionDialogMode.YesNoCancel, , DialogReturnCode.Cancel, NStr("en='Edit contact information content';ru='Редактирование состава контактной информации';vi='Soạn thành phần thông tin liên hệ'"));
