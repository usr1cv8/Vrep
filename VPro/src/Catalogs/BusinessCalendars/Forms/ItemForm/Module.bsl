...
Procedure MoveDay(Command)
	...
	DateChoiceParameters.Insert("Title",					NStr("en='Select transfer data';ru='Выбор даты переноса';vi='Chọn ngày chuyển'"));
	DateChoiceParameters.Insert("ExplanationText",				StringFunctionsClientServer.SubstituteParametersInString(
																NStr("en='Select a date day %1 will be transferred to (%2)';ru='Выберите дату, на которую будет осуществлен перенос дня %1 (%2)';vi='Hãy chọn ngày mà sẽ thực hiện chuyển ngày %1 (%2)'"), 
...
""
"Записать?';vi='Dữ liệu lịch sản xuất vẫn chưa được ghi lại."
"Chỉ có thể in sau khi ghi lại dữ liệu."
""
"Ghi lại?'"),
...
Procedure FillPresentationTransfers(Form)
	...
	For Each KeyAndValue IN Form.TransfersOfDays Do
		...
		Form.ListTransfers.Add(DateSource, StringFunctionsClientServer.SubstituteParametersInString(
															NStr("en='%1 (%3) is transferred to %2 (%4)';ru='%1 (%3) перенесен на %2 (%4)';vi='%1 (%3) chuyển sang %2 (%4)'"),
