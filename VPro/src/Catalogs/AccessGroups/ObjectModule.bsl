...
"можно изменять, либо в привилегированном режиме, либо при наличии роли ""Полные права"".';vi='Có thể thay đổi"
"nhóm truy cập định trước"
"Quản trị, hoặc ở chế độ độc quyền, hoặc khi có vai trò ""Toàn quyền"".'");
		EndIf;
...
"группы внешних пользователей недопустимы.';vi='Nhóm truy cập định trước Người quản trị"
"chỉ có thể bao gồm người sử dụng."
""
"Nhóm người sử dụng, người sử dụng ngoài và"
"nhóm người sử dụng ngoài không hợp lệ.'");
			EndIf;
		EndDo;
...
"Администратор может быть только у предопределенной группы доступа Администраторы.';vi='Hồ sơ định trước"
"Người quản trị chỉ có thể thuộc nhóm truy cập định trước Quản trị.'");
	EndIf;
