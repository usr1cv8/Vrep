...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Object.Ref.IsEmpty() Then
		OpenError = NStr("en='You can create report variant only from the report form';ru='Новый вариант отчета можно создать только из формы отчета';vi='Phương án mới của báo cáo có thể chỉ được tạo từ biểu mẫu báo cáo'");
		Return;
	EndIf;
...
Procedure DescriptionStartChoice(Item, ChoiceData, StandardProcessing)
	...
	ReportsVariantsClient.EditMultilineText(ThisObject, Item.EditText, Object, "Definition", NStr("en='Definitions';ru='Определение';vi='Xác định'"));
EndProcedure
