...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	AdditionalParameters.Insert("ItemNameForPlacement", "AdditionalAttributes");
...
Procedure AddAdditionalAttribute(Command)
	...
	FormParameters.Insert("CurrentSetOfProperties", PredefinedValue("Catalog.AdditionalAttributesAndInformationSets.Catalog_ContactPersons"));
