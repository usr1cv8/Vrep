...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If UseAdditAttributes AND UseAdditInfo Then
		Title = Object.Description + " " + NStr("en='(Set of additional attributes and information)';ru='(Набор дополнительных реквизитов и сведений)';vi='(Tập hợp mục tin và thông tin bổ sung)'")
		
	ElsIf UseAdditAttributes Then
		Title = Object.Description + " " + NStr("en='(Additional attribute set)';ru='(Набор дополнительных реквизитов)';vi='(Tập hợp mục tin bổ sung)'")
		
	ElsIf UseAdditInfo Then
		Title = Object.Description + " " + NStr("en='(Additional information set)';ru='(Набор дополнительных сведений)';vi='(Tập hợp thông tin bổ sung)'")
	EndIf;
