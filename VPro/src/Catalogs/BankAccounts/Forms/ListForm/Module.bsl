...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If ValueIsFilled(AccountsOwner) Then
		...
		AutoTitle = False;
		Title = NStr("en='Bank accounts of ';ru='Банковские счета ';vi='Tài khoản ngân hàng '") + " """ + AccountsOwner + """";
...
Procedure WriteMainAccount(ParametersStructure)
	...
	Except
		...
		MessageText = NStr("en='Cannot lock object for changing the main bank account.';ru='Не удалось заблокировать объект для изменения основного банковского счета.';vi='Không thể phong tỏa đối tượng để thay đổi tài khoản ngân hàng chính.'", Metadata.DefaultLanguage.LanguageCode);
