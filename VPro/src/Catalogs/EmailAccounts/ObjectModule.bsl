...
Procedure FillObjectByDefaultValues() Export
	...
	UserName = NStr("en='1C:Enterprise';ru='1С:Предприятие';vi='1С:DOANH NGHIỆP'");
...
Procedure FillCheckProcessing(Cancel, CheckedAttributes)
	...
	If Not IsBlankString(EmailAddress) AND Not CommonUseClientServer.EmailAddressMeetsRequirements(EmailAddress, True) Then
		CommonUseClientServer.MessageToUser(
			NStr("en='Incorrect postal address.';ru='Почтовый адрес заполнен неверно.';vi='Điền sai địa chỉ E-mail.'"), ThisObject, "EmailAddress");
