...
"Рабочее место с таким идентификатором клиента уже существует.';vi='Lỗi lưu chỗ làm việc!"
"Đã có chỗ làm việc với Tên định danh Client như vậy.'");
...
"Продолжить сохранение с указанным наименованием?';vi='Chỉ ra tên gọi không đơn trị của vị trí làm việc!"
"Có thể sau này điều này làm khó khăn cho việc đồng nhất và chọn việc trí làm việc."
"Nên chỉ ra tên gọi đơn trị của các vị trí làm việc."
"Tiếp tục lưu có tên gọi đã chọn?'");
