...
"Открыть существующее рабочее место?';vi='Không cần tạo chỗ làm việc mới."
"Đối với Tên định danh này của Client, chỗ làm việc đã được tạo ra."
"Mở chỗ làm việc hiện có?'");
