...
Procedure UpdateInformationInServiceInformationRegister(Cancel)
	...
	WriteLogEvent(
			NStr("en='Automatic discounts. Service information on automatic discounts';ru='Автоматические скидки. Служебная информация по автоматическим скидкам';vi='Chiết khấu tự động. Thông tin hệ thống theo chiết khấu tự động'",
...
"Подробности в журнале регистрации.';vi='Không thể ghi lại thông tin hệ thống theo chiết khấu, phụ thu tự động."
"Chi tiết xem trong nhật ký chứng từ.'");
	EndIf;
