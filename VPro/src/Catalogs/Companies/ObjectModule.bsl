...
Procedure BeforeWrite(Cancel)
	...
	If IsNew() And Not GetFunctionalOption("MultipleCompaniesAccounting") Then
		CommonUseClientServer.MessageToUser(NStr("en='In the application, accounting by several companies is disabled.';ru='В программе отключен учет по нескольким организациям.';vi='Trong chương trình ngắt bỏ kết toán theo nhiều doanh nghiệp.'"));
		Cancel = True;
	EndIf;
