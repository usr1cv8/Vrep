...
Procedure AddPrintCommands(PrintCommands) Export
	...
	PrintCommand.Presentation	= NStr("en='Attributes';ru='Реквизиты';vi='Mục tin'");
	PrintCommand.FormsList		= "ItemForm,ListForm";
	PrintCommand.FormTitle		= NStr("en='Print company attributes';ru='Печать реквизитов организации';vi='In các mục tin của doanh nghiệp'");
...
Function PreviewPrintedFormProformaInvoice(ObjectsArray, PrintObjects, TemplateName) Export
	...
	Header.Insert("CustomerPresentation",	NStr("en='Field contains customer information: legal name, TIN, legal address, phones.';ru='Поле содержит информацию покупателя: полное наименование, ИНН, юридический адрес, телефоны.';vi='Trường bao gồm thông tin của khách hàng: tên gọi đầy đủ, MST, địa chỉ pháp nhân, điện thoại.'"));
	
	Inventory = New Structure;
	Inventory.Insert("LineNumber",				1);
	Inventory.Insert("ProductDescription",		NStr("en='Inventory for preview';ru='Запас для предварительного просмотра';vi='Vật tư để xem trước'"));
	Inventory.Insert("SKU",						NStr("en='SKU-0000001';ru='АРТ-0000001';vi='АРТ-0000001'"));
	...
	Inventory.Insert("VATAmount",				NStr("en='VAT amount';ru='Сумма НДС';vi='Thuế GTGT'"));
...
Procedure Print(ObjectsArray,
	...
	If PrintManagement.NeedToPrintTemplate(PrintFormsCollection, "CompanyAttributes") Then
		...
		PrintManagement.OutputSpreadsheetDocumentToCollection(
			PrintFormsCollection,
			"CompanyAttributes",
			NStr("en='Company details';ru='Реквизиты организации';vi='Thông tin của doanh nghiệp'"),
