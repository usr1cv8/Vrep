...
Procedure InsertCounterpartyName(Command)
	InsertInfobaseParameter(PredefinedValue("Enum.ContractsWithCounterpartiesTemplatesParameters.CounterpartyName"));
EndProcedure
...
&AtClient
Procedure InsertPassportDataExpiryDate(Command)
