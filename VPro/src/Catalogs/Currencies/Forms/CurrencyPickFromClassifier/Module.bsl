...
Procedure ProcessChoiceInCurrencyList(StandardProcessing = Undefined)
	...
	ShowUserNotification(
		NStr("en='Currencies are added.';ru='Валюты добавлены.';vi='Tiền tệ được thêm.'"), ,
		?(StandardSubsystemsClientReUse.ClientWorkParameters().DataSeparationEnabled AND IsRates, 
			NStr("en='Rates will be automatically imported after some time.';ru='Курсы будут загружены автоматически через непродолжительное время.';vi='Tỷ giá sẽ được tự động kết nhập sau một thời gian ngắn.'"), ""),
