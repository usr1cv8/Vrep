...
Procedure SetWritingParametersDeclensions(Form)
	...
	If Form.InWordsField4HomeLanguage = "Female" Then
		Items.InWordsField1HomeLanguage.Title = NStr("en='One';ru='Одно';vi='Một'");
		Items.InWordsField2HomeLanguage.Title = NStr("en='Two';ru='Две';vi='Hai'");
	...
	If Form.InWordsField8HomeLanguage = "Female" Then
		Items.InWordsField5HomeLanguage.Title = NStr("en='One';ru='Одно';vi='Một'");
		Items.InWordsField6HomeLanguage.Title = NStr("en='Two';ru='Две';vi='Hai'");
