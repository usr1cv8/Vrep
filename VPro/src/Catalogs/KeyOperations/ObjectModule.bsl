...
Procedure CheckPriority(Cancel)
	...
	If Selection.Next() Then
		MessageText = NStr("en='Key operation with priority ""%1"" already exists (""%2"").';ru='Ключевая операция с приоритетом ""%1"" уже существует (%2).';vi='Giao dịch chính vơi ưu tiên ""%1"" đã tồn tại (%2).'");
