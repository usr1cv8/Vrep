...
Procedure DeleteFromLocalFilesCacheExecute()
	...
	QuestionText = NStr("en='Delete the selected files from the main working directory?';ru='Удалить выбранные файлы из основного рабочего каталога?';vi='Xóa các tệp đã chọn khỏi thư mục làm việc chính?'");
...
"занятые для редактирования.';vi='Không thể xóa bỏ khỏi thư mục làm việc chính tệp,"
"đang bị chiếm để soạn.'"));
	EndIf;
