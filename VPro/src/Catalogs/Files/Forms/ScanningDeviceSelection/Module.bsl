...
Procedure OnOpen(Cancel)
	...
	If ItemCount = 0 Then
		Cancel = True;
		ShowMessageBox(, NStr("en='Scanner is not installed. Contact the application administrator.';ru='Не установлен сканер. Обратитесь к администратору программы.';vi='Chưa cài đặt máy quét ảnh. Hãy liên hệ với người quản trị chương trình.'"));
	Else
