...
Function AllFormsSettings(UserName) Export
	...
	FormsList.Add("ExternalDataProcessor.StandardEventLogMonitor.Form.EventsJournal", 
		NStr("en='Standard.Event log';ru='Стандартные.Журнал регистрации';vi='Chuẩn.Nhật ký ghi nhận'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardEventLogMonitor.Form.EventForm", 
		NStr("en='Standard.Event log, Event';ru='Стандартные.Журнал регистрации, Событие';vi='Chuẩn.Nhật ký ghi nhận, Sự kiện'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardEventLogMonitor.Form.EventsJournalFilter", 
		NStr("en='Standard.Event log, Customize event selection';ru='Стандартные.Журнал регистрации, Настройка отбора событий';vi='Chuẩn.Nhật ký ghi nhận, Tùy chỉnh lọc sự kiện'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardFindByRef.Form.MainForm", 
		NStr("en='Standard.Search for links to object';ru='Стандартные.Поиск ссылок на объект';vi='Chuẩn.Tìm kiếm tham chiếu đến đối tượng'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardFullTextSearchManagement.Form.MainForm", 
		NStr("en='Standard.Manage full-text search';ru='Стандартные.Управление полнотекстовым поиском';vi='Chuẩn.Quản lý bằng cách tìm kiếm toàn văn'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardDocumentsPosting.Form.MainForm", 
		NStr("en='Standard.Document posting';ru='Стандартные.Проведение документов';vi='Chuẩn.Kết chuyển chứng từ'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardMarkedObjectDeletion.Form.Form", 
		NStr("en='Standard.Delete selected objects';ru='Стандартные.Удаление помеченных объектов';vi='Chuẩn.Xóa bỏ đối tượng đã đánh dấu'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardExternalDataSourceManagement.Form.Form", 
		NStr("en='Standard.Manage external data sources';ru='Стандартные.Управление внешними источниками данных';vi='Chuẩn. Xóa bỏ nguồn dữ liệu ngoài'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardTotalsManagement.Form.MainForm", 
		NStr("en='Standard.Total management';ru='Стандартные.Управление итогами';vi='Chuẩn.Quản lý phần tổng kết'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardActiveUsers.Form.ActiveUsersListForm", 
		NStr("en='Standard.Active users';ru='Стандартные.Активные пользователи';vi='Chuẩn.Người sử dụng đang làm việc'") , False, PictureLib.Form);
...
Function MetadataObjectsForms()
	...
	GetFormListOfMetadataObject(Metadata.FilterCriteria, "FilterCriterion", NStr("en='Filter criterion';ru='Критерий отбора';vi='Thể loại lọc'"),
		StandardFormNames, PictureLib.FilterCriterion, FormsList);
		
	StandardFormNames = New ValueList;
	GetFormListOfMetadataObject(Metadata.SettingsStorages, "SettingsStorage", NStr("en='Settings storage';ru='Хранилище настроек';vi='Kho chứa tùy chỉnh'"),
	...
	GetFormListOfMetadataObject(Metadata.Catalogs, "Catalog", NStr("en='Catalog';ru='Справочник';vi='Danh mục'"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm");
	GetFormListOfMetadataObject(Metadata.Documents, "Document", NStr("en='Document';ru='документ';vi='chứng từ'"),
		StandardFormNames, PictureLib.Document, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("Form");
	GetFormListOfMetadataObject(Metadata.DocumentJournals, "DocumentJournal", NStr("en='Document journal';ru='Журнал документов';vi='Nhật ký chứng từ'"),
		StandardFormNames, PictureLib.DocumentJournal, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm");
	GetFormListOfMetadataObject(Metadata.Enums, "Enum", NStr("en='Enum';ru='Перечисление';vi='Chuyển khoản'"),
	...
	GetFormListOfMetadataObject(Metadata.Reports, "Report", NStr("en='Report';ru='Отчет';vi='Báo cáo'"),
		StandardFormNames, PictureLib.Report, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("Form");
	GetFormListOfMetadataObject(Metadata.DataProcessors, "DataProcessor", NStr("en='Processing';ru='Обработка';vi='Bộ xử lý'"),
	...
	StandardFormNames.Add("ChoiceForm");
	StandardFormNames.Add("FolderChoiceForm");
	GetFormListOfMetadataObject(Metadata.ChartsOfCharacteristicTypes, "ChartOfCharacteristicTypes", NStr("en='Chart of characteristic types';ru='План видов характеристик';vi='Hệ thống dạng đặc tính'"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm");
	GetFormListOfMetadataObject(Metadata.ChartsOfAccounts, "ChartOfAccounts", NStr("en='Chart of accounts';ru='План счетов';vi='Hệ thống tài khoản'"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm");
	GetFormListOfMetadataObject(Metadata.ChartsOfCalculationTypes, "ChartOfCalculationTypes", NStr("en='Chart of calculation types';ru='План видов расчета';vi='Hệ thống dạng tính toán'"),
		StandardFormNames, PictureLib.ChartOfCalculationTypes, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("RecordForm");
	StandardFormNames.Add("ListForm");
	GetFormListOfMetadataObject(Metadata.InformationRegisters, "InformationRegister", NStr("en='Information register';ru='Регистр сведений';vi='Biểu ghi thông tin'"),
		StandardFormNames, PictureLib.InformationRegister, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("ListForm");
	GetFormListOfMetadataObject(Metadata.AccumulationRegisters, "AccumulationRegister", NStr("en='Accumulation register';ru='Регистр накопления';vi='Biểu ghi tích lũy'"),
		StandardFormNames, PictureLib.AccumulationRegister, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("ListForm");
	GetFormListOfMetadataObject(Metadata.AccountingRegisters, "AccountingRegister", NStr("en='Accounting register';ru='Регистр бухгалтерии';vi='Biểu ghi kế toán'"),
		StandardFormNames, PictureLib.AccountingRegister, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("ListForm");
	GetFormListOfMetadataObject(Metadata.CalculationRegisters, "CalculationRegister", NStr("en='Calculation register';ru='Регистр расчета';vi='Biểu ghi tính toán'"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm");
	GetFormListOfMetadataObject(Metadata.BusinessProcesses, "BusinessProcess", NStr("en='Business process';ru='Бизнес-процесс';vi='Quy trình nghiệp vụ'"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm");
	GetFormListOfMetadataObject(Metadata.Tasks, "Task", NStr("en='Task';ru='Задача';vi='Nhiệm vụ'"),
		StandardFormNames, PictureLib.Task, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("RecordForm");
	StandardFormNames.Add("ListForm");
	GetFormListOfMetadataObject(Metadata.ExternalDataSources, "ExternalDataSource", NStr("en='External data sources';ru='Внешние источники данных';vi='Nguồn dữ liệu ngoài'"),
...
Procedure AddFormTypeToPresentation(Object, Form, FormName)
	...
	If Form = Object.DefaultListForm Then
		FormName = StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en='%1 (list)';ru='%1 (список)';vi='%1 (danh sách)'"), FormName);
	ElsIf Form = Object.DefaultChoiceForm Then
		FormName = StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en='%1 (selection)';ru='%1 (выбор)';vi='%1 (lựa chọn)'"), FormName);
	ElsIf Form = Object.DefaultFolderForm Then
		FormName = StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en='%1 (group)';ru='%1 (группа)';vi='%1 (nhóm)'"), FormName);
	EndIf;
...
"Список пропущенных вариантов отчетов:';vi='"
"Không thể sao chép phương án báo cáo cá nhân."
"Để người sử dụng khác có thể"
"sử dụng phương án báo cáo cá nhân thì cần lưu lại nó và bỏ dấu ""Chỉ đối với tác giả""."
"Danh sách các phương án báo cáo bỏ lỡ:"
"'");
...
"У следующих пользователй недостаточно прав на отчеты:';vi='"
"Người sử dụng sau đây không đủ quyền làm việc với báo cáo:'");
		Spreadsheet.Put(HeaderArea);
...
Procedure AddDesktopAndCommandInterfaceSettings(Form, SettingsTree)
	...
	If Not IsBlankString(Form.Search) Then
		If Find(Upper(NStr("en='Desktop and command interface';ru='Рабочий стол и командный интерфейс';vi='Bàn làm việc và giao diện lệnh'")), Upper(Form.Search)) = 0 Then
			Return;
		EndIf;
	EndIf;
	...
	If AllSettingsKeys.Count() > 0 Then
		...
		InterfaceNewRow.Setting = NStr("en='Desktop and command interface';ru='Рабочий стол и командный интерфейс';vi='Bàn làm việc và giao diện lệnh'");
		InterfaceNewRow.Picture = PictureLib.Picture;
		InterfaceNewRow.RowType = NStr("en='Desktop and command interface';ru='Рабочий стол и командный интерфейс';vi='Bàn làm việc và giao diện lệnh'");
	...
	If DesktopSettingKeys.Count() > 0 Then
		...
		NewInterfaceSubrow.Setting = NStr("en='Desktop';ru='Рабочий стол';vi='Bàn làm việc'");
	...
	If KeywordsSettingsInterface.Count() > 0 Then
		...
		NewInterfaceSubrow = InterfaceNewRow.Rows.Add();
		NewInterfaceSubrow.Setting = NStr("en='Command interface';ru='Командный интерфейс';vi='Giao diện lệnh'");
		NewInterfaceSubrow.Picture = PictureLib.Picture;
...
Procedure FillExternalViewSettingsList(Form)
	...
	For Each SettingForms IN FormsSettings Do
		...
		ElsIf MetadataObjectPresentation[0] = NStr("en='Standard';ru='Стандартные';vi='Chuẩn'") Then
	...
	DesktopAndCommandInterface = ExternalViewSettings.Rows.Find(NStr("en='Desktop and command interface';ru='Рабочий стол и командный интерфейс';vi='Bàn làm việc và giao diện lệnh'"), "Setting");
...
Procedure FillOtherSettingsList(Form)
	...
	If Keys.Count() > 0 Then
		...
		If Not IsBlankString(Form.Search) Then
			If Find(Upper(NStr("en='Personal settings';ru='Персональные настройки';vi='Tùy chỉnh cá nhân'")), Upper(Form.Search)) = 0 Then
				OutputSetting = False;
			EndIf;
		EndIf;
		
		If OutputSetting Then
			Setting = NStr("en='Personal settings';ru='Персональные настройки';vi='Tùy chỉnh cá nhân'");
	...
	If Not IsBlankString(Form.Search) Then
		...
		If Find(Upper(NStr("en='Spreadsheet document print settings';ru='Настройки печати табличных документов';vi='Tùy chỉnh in văn bản dạng bảng'")), Upper(Form.Search)) = 0 Then
			OutputSetting = False;
		EndIf;
	...
	If IsPrintSettings
		...
		Setting = NStr("en='Spreadsheet document print settings';ru='Настройки печати табличных документов';vi='Tùy chỉnh in văn bản dạng bảng'");
	...
	If Not IsBlankString(Form.Search) Then
		...
		If Find(Upper(NStr("en='Favorites';ru='Избранное';vi='Mục ưa thích'")), Upper(Form.Search)) = 0 Then
			OutputSetting = False;
		EndIf;
	...
	If IsFavorites
		...
		Setting = NStr("en='Favorites';ru='Избранное';vi='Mục ưa thích'");
	...
	If Not IsBlankString(Form.Search) Then
		...
		If Find(Upper(NStr("en='Other settings';ru='Прочие настройки';vi='Tùy chỉnh khác'")), Upper(Form.Search)) = 0 Then
			OutputSetting = False;
		EndIf;
	...
	If OtherKeys.Count() <> 0
		AND OutputSetting Then
		Setting = NStr("en='Other settings';ru='Прочие настройки';vi='Tùy chỉnh khác'");
		Picture = PictureLib.OtherUserSettings;
		SettingType = "OtherSetting";
