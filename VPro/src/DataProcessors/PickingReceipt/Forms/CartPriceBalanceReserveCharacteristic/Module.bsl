...
Procedure CouncilServicesOutputInReceiptDocuments()
	...
	If SelectionSettingsCache.CouncilServicesOutputInReceiptDocuments Then
		...
		FormTitle = NStr("en='Advice';ru='Совет';vi='Lời khuyên'");
		MessageText = NStr("en='Services in the reimbursement documents reflect company expenses, that is why characteristics are limited.';ru='Услуги в приходных документах отражают расходы компании, поэтому выбор характеристик ограничен.';vi='Dịch vụ trong chứng từ nhận hàng phản ánh chi phí của công ty, vì thế việc chọn đặc tính bị hạn chế.'");
