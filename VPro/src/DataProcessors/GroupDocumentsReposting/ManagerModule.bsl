...
Procedure RepostingDocuments(ParametersStructure, StorageAddress) Export
	...
	For IndexOf = 0 To TotalDocuments - 1 Do
		...
		Except
			...
			MessageText = NStr("en='Document %1 is not posted. %2 Due to: %3';ru='Документ %1 не проведен! %2 По причине: %3';vi='Chưa kết chuyển chứng từ %1! %2 Nguyên nhân: %3'");
...
"Необходимо исправить указанные ошибки, после чего принять решение о повторном перепроведении документов.';vi='Khi kết chuyển lại đã thấy %1 lỗi."
"Thông báo về 50 lỗi đầu tiên được đưa ra để tham khảo."
"Cần sửa những lỗi đã chỉ ra, sau đó áp dụng giải quyết việc kết chuyển lại chứng từ.'");
