...
Procedure GoFromSetupPages()
	...
	If Object.ExecuteAutomaticBackup Then
		...
		ShowUserNotification(NStr("en='Backup';ru='Резервное копирование';vi='Sao lưu dự phòng'"), SettingsFormName,
			NStr("en='Backup is set up.';ru='Резервное копирование настроено.';vi='Đã tùy chỉnh sao lưu dự phòng.'"));
