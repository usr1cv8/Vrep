...
Procedure BeforeClose(Cancel, StandardProcessing)
	...
	If ResponseBeforeClose <> True Then
		...
		ShowQueryBox(NOTifyDescription, NStr("en='Settings were changed. Save changes?';ru='Настройки были изменены. Сохранить изменения?';vi='Tùy chỉnh đã thay đổi. Lưu lại những thay đổi?'"), 
