...
Procedure BeforeClose(Cancel, StandardProcessing)
	...
	If ResponseBeforeClose <> True Then
		...
		ShowQueryBox(NOTifyDescription, NStr("en='Data was changed. Save the changes?';ru='Данные были изменены. Сохранить изменения?';vi='Đã thay đổi dữ liệu. Lưu các thay đổi?'"), 
...
Procedure ApplyRestrictionsSettings()
	...
	ToolTipTemplate = NStr("en='Maximum %1';ru='Максимум %1';vi='Tối đa %1'");
...
Function SignatureNumberOfCopies(Val Quantity)
	...
	PresentationArray.Add(NStr("en='last copy';ru='последнюю копию';vi='bản sao cuối cùng'"));
	PresentationArray.Add(NStr("en='Last copies';ru='последние копии';vi='bản sao cuối cùng'"));
	PresentationArray.Add(NStr("en='last copies';ru='последних копий';vi='của bản sao cuối cùng'"));
