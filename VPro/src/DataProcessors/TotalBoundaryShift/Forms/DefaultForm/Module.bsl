...
Function BackGroundJobStart(Val UUID)
	...
	Start = LongActions.ExecuteInBackground(
		...
		New Structure,
		NStr("en='Totals and aggregates: Accelerated document posting and report generation';ru='Итоги и агрегаты: Ускорение проведения документов и формирования отчетов';vi='Tổng kết và thống kê: Đẩy nhanh việc kết chuyển chứng từ và lập báo cáo'"));
