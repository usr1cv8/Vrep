...
Procedure DeleteClick(Item)
	...
	ShowQueryBox(NOTifyDescription, NStr("en='Delete your comment?';ru='Удалить Ваш комментарий?';vi='Xóa ghi chú của bạn?'"), QuestionDialogMode.YesNo, , DialogReturnCode.Yes);
