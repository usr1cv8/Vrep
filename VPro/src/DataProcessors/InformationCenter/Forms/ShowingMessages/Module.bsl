...
Procedure OpenAllMessages()
	...
	Title = NStr("en='Messages';ru='Сообщения';vi='Thông báo'");
	GenerateAllNewsList();
	Items.CommonGroup.CurrentPage = Items.GroupAllNewsPage;
...
Procedure OpenNews(ID)
	...
	Items.CommonGroup.CurrentPage = Items.GroupNewsPage;
...
Procedure GenerateAllNewsList()
	...
	For Iteration = 0 To AllNewsTable.Count() - 1 Do
		...
		GroupNews.Group         = ChildFormItemsGroup.HorizontalIfPossible;
