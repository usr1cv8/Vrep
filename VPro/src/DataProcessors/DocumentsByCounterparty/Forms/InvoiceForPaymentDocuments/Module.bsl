...
Procedure UpdateDocumentsTableAtServer()
	...
	If IsBlankString(QueryTextByDocuments) Then
		...
		CommonUseClientServer.MessageToUser(NStr("en='It is necessary to set content of documents';ru='Необходимо настроить состав документов';vi='Cần tùy chỉnh thành phần chứng từ'"),,"ThisForm");
		Return;
