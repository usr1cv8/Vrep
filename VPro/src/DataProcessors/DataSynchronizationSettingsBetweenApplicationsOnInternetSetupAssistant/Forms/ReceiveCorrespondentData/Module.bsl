...
Procedure DataReceivingExpectation_LongOperationProcessing(Cancel)
	...
	Try
		...
		Else
			...
			Raise NStr("en='Unknown mode of correspondent data receipt.';ru='Неизвестный режим получения данных корреспондента.';vi='Chưa xác định chế độ nhận dữ liệu của cơ sở dữ liệu thứ hai.'");
