...
"с ""%1""?';vi='Ngắt đồng bộ hóa dữ liệu'"), Parameters.CorrespondentDescription);
...
"с ""%1"" отключена.';vi='Đã ngắt đồng bộ hóa dữ liệu với"
"""%1"".'"), Parameters.CorrespondentDescription);
