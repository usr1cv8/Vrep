...
"регистрацию ""%1"" на узлах?';vi='Thay đổi"
"ghi nhận ""%1"" tại nút?'");
...
Procedure ChangeRegistrationEnd(Val QuestionResult, Val AdditionalParameters) Export
	...
	If Quantity > 0 Then
		Text = NStr("en='Registration of %1 was changed on %2 nodes';ru='Регистрация %1 была изменена на %2 узлах';vi='Đã thay đổi ghi nhận %1 tại các nút %2'");
		NotificationTitle = NStr("en='Change registration:';ru='Изменение регистрации:';vi='Thay đổi đăng ký:'");
