...
Procedure RefreshWidgetCashAssets()
	...
	While Selection.Next() Do
		...
		ToolTip = NStr("en='Balance ';vi='Số dư ';") + Selection.AmountClosingBalance + NStr("en=' on ';vi=' ngày '") + Format(Selection.Period, "DF=dd.MM.yyyy");
...
Procedure RefreshWidgetProfitLoss()
	...
	While Selection.Next() Do
		...
		Point.Text = Format(Selection.Period, "DF=dd.MM.yy");
		Point.Details = Selection.Period;
		ToolTip = ?(ProfitLoss < 0, NStr("en='Loss ';vi='Lỗ ';") + -ProfitLoss, NStr("en='Profit ';vi='Lãi ';") + ProfitLoss) + NStr("en=' on ';vi=' ngày '") + Format(Selection.Period, "DF=dd.MM.yyyy");
...
Procedure UpdateSalesWidget()
	...
	While Selection.Next() Do
		...
		Point.Text = Format(Selection.Period, "DF=dd.MM.yy");
		Point.Details = Selection.Period;
		ToolTip = NStr("en='Sales amount ';vi='Sản lượng bán ra ';") + Selection.Amount + NStr("en=' on ';vi=' ngày '") + Format(Selection.Period, "DF=dd.MM.yyyy");
