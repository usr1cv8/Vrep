...
Procedure RefreshCAReceiptAndExpenseChart()
	...
	While Selection.Next() Do
		...
		Point.Text = Format(Selection.Period, "DF=dd.MM.yy");
		ToolTip = NStr("en='Receipt ';vi='Thu'") + Selection.AmountReceipt + NStr("en=' on ';vi=' ngày '") + Format(Selection.Period, "DF=dd.MM.yyyy");
	...
	While Selection.Next() Do
		...
		Point.Text = Format(Selection.Period, "DF=dd.MM.yy");
		ToolTip = NStr("en='Expense ';vi='Chi'") + Selection.AmountExpense + NStr("en=' on ';vi=' ngày '") + Format(Selection.Period, "DF=dd.MM.yyyy");
