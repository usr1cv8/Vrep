...
Procedure RefreshChartCreditors()
	...
	Point = ChartCreditors.Points.Add(NStr("en='Debt = ';vi='Công nợ = ';"));
	...
	While Selection.Next() Do
		...
		ToolTip = NStr("en='Debt ';vi='Công nợ ';") + Selection.CounterpartyPresentation + " " + Selection.Debt;
...
Procedure RefreshChartAndWidgetCreditorsByDeadlines()
	...
	Point = ChartCreditorsOnTerms.Points.Add(NStr("en='Debt = ';vi='Công nợ = ';"));
	
	DebtLessThan7 = NStr("en='Up to 7 days';ru='до 7 дней';vi='dưới 7 ngày'");
	DebtLessThan30 = NStr("en='8 - 30 days';ru='8 - 30 дней';vi='8 - 30 ngày'");
	DebtMoreThan31 = NStr("en='over 31 days';ru='от 31 дня';vi='trên 31 ngày'");
	...
	If SelectionTotal.Next() Then
		...
		ToolTip = NStr("en='Overdue less than 7 days ';vi='Quá hạn dưới 7 ngày '") + SelectionTotal.DebtLessThan7;
		...
		ToolTip = NStr("en='Overdue from 8 to 30 days ';vi='Quá hạn từ 8 đến 30 ngày '") + SelectionTotal.DebtLessThan30;
		...
		ToolTip = NStr("en='Overdue over 31 days ';vi='Quá hạn hơn 31 ngày '") + SelectionTotal.DebtMoreThan31;
...
Procedure RefreshChartDebtDynamics()
	...
	While Selection.Next() Do
		...
		ToolTip = NStr("en='Debt ';vi='Công nợ '") + Selection.AmountClosingBalance + NStr("en=' on ';vi=' ngày '") + Format(Selection.Period, "DLF=D");
