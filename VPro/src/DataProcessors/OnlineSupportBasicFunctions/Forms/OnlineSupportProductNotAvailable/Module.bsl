...
Function MessageParametersToTechicalSupport()
	...
	Result.Insert("Subject",
		NStr("en='Online support. Product online support is not provided.';ru='Интернет-поддержка. Интернет-поддержка продукта не оказывается.';vi='Hỗ trợ qua Internet. Hỗ trợ sản phẩm qua Internet bị từ chối.'"));
