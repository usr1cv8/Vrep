...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Items.FormAllow.Title = NStr("en='Next >';ru='Далее  >';vi='Tiếp theo >'");
...
Procedure Next(Command)
	...
	If Items.GroupPages.CurrentPage = Items.PermissionPage Then
		...
		Items.FormAllow.Title = NStr("en='Configure permissions in the server cluster';ru='Настроить разрешения в кластере серверов';vi='Tùy chỉnh cho phép trong Cluster server'");
