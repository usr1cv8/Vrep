...
Function GenerateApplicationNameInService()
	...
	Result = StrReplace(Result, "[Explanation]", NStr("en='online application';ru='приложение в Интернете';vi='ứng dụng trên Internet'"));
...
Function SystemTitle()
	...
	Return ?(IsBlankString(Result), NStr("en='Offline work place';ru='Автономное рабочее место';vi='Chỗ làm việc độc lập'"), Result);
EndFunction
