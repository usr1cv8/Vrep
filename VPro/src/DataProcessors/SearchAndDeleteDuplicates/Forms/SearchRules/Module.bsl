...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Title = StrReplace( NStr("en='Rules of searching for duplicates ""%1""';ru='Правила поиска дублей ""%1""';vi='Quy tắc tìm kiếm bản sao ""%1""'"), "%1", Parameters.SelectionAreaPresentation);
...
Procedure ConsiderAppliedRulesOnChange(Item)
	...
	HeaderText = NStr("en='Warning';ru='Предупреждение';vi='Cảnh báo'");
...
""
"Отключить использование поставляемых ограничений?';vi='Chú ý: Việc tìm kiếm và xóa bỏ các phần tử trùng lặp mà chưa ghi nhận các hạn chế cho phép có thể dẫn đến xung đột dữ liệu trong chương trình."
""
"Ngắt bỏ sử dụng các hạn chế cung cấp?'");
...
Function SelectionErrors() 
	...
	Return NStr("en='Specify at least one rule for duplicate search.';ru='Необходимо указать хотя бы одно правило поиска дублей.';vi='Cần chỉ ra ít nhất một quy tắc tìm kiếm bản sao.'");
EndFunction
