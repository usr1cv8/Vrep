...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Items.ObjectToMap.Title = StringFunctionsClientServer.SubstituteParametersInString(
		NStr("en='Object in ""%1""';ru='Объект в ""%1""';vi='Đối tượng trong ""%1""'"), Parameters.Application1);
		
	Items.Header.Title = StringFunctionsClientServer.SubstituteParametersInString(
		NStr("en='Object in ""%1""';ru='Объект в ""%1""';vi='Đối tượng trong ""%1""'"), Parameters.Application2);
