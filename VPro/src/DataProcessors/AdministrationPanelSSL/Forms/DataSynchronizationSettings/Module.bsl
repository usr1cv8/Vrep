...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If RunMode.SaaS Then
		...
		Items.SectionDescription.Title = NStr("en='Configure data synchronization with my applications.';ru='Настройка синхронизации данных с моими приложениями.';vi='Tùy chỉnh đồng bộ hóa dữ liệu với các ứng dụng của tôi.'");
		Items.ExplanationDataSynchronizationSettings.Title = NStr("en='Setting and data synchronization with my applications.';ru='Настройка и выполнение синхронизации данных с моими приложениями.';vi='Tùy chỉnh và thực hiện đồng bộ hóa dữ liệu với các ứng dụng của tôi.'");
		Items.ExplanationOpenDataImportProhibitionDates.Title = NStr("en='Prohibit import of previous period data from other applications.';ru='Запрет загрузки данных прошлых периодов из других приложений.';vi='Cấm kết nhập dữ liệu của các kỳ trước từ các ứng dụng khác.'");
