...
"от нескольких секунд до многих часов (в зависимости от объема данных).';vi='Bật hạn chế truy cập ở mức độ bản ghi?"
""
"Cần điền dữ liệu mà sẽ được thực hiện bởi các phần "
"nhiệm vụ thường kỳ ""Điền dữ liệu để hạn chế truy cập"""
"(quá trình thực hiện mô tả trong nhật ký sự kiện)."
""
"Việc thực hiện này có thể làm chậm công việc của chương trình rất nhiều và"
"được tiến hành từ vài giây đến nhiều giờ (tùy thuộc vào khối lượng dữ liệu).'");
