...
Procedure SaveProcessing(ReportKey, VariantKey, Settings, SettingsDescription, User)
	If Not ReportsVariantsReUse.AddRight() Then
		Raise NStr("en='Insufficient rights to save report variants.';ru='Недостаточно прав для сохранения вариантов отчетов';vi='Không đủ quyền để lưu phương án báo cáo'");
	EndIf;
