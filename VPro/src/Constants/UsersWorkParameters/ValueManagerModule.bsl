...
Function InaccessibleRightsByTypesUsers()
	...
	Rights.Insert("Administration",       NStr("en='Administration';ru='Администрирование';vi='Quản trị'"));
	Rights.Insert("DataAdministration", NStr("en='Data administration';ru='Администрирование данных';vi='Quản trị dữ liệu'"));
	
	Rights = New Map;
	InaccessibleRights.Insert(Enums.UserTypes.LocalApplicationUser, Rights);
	Rights.Insert("Administration",                     NStr("en='Administration';ru='Администрирование';vi='Quản trị'"));
	Rights.Insert("UpdateDataBaseConfiguration",      NStr("en='Update infobase configuration';ru='Обновление конфигурации базы данных';vi='Cập nhật cấu hình cơ sở dữ liệu'"));
	
	Rights = New Map;
	InaccessibleRights.Insert(Enums.UserTypes.DataAreaUser, Rights);
	Rights.Insert("Administration",                     NStr("en='Administration';ru='Администрирование';vi='Quản trị'"));
	Rights.Insert("UpdateDataBaseConfiguration",      NStr("en='Update infobase configuration';ru='Обновление конфигурации базы данных';vi='Cập nhật cấu hình cơ sở dữ liệu'"));
	Rights.Insert("ThickClient",                         NStr("en='Thick client';ru='Толстый клиент';vi='Client dày'"));
	Rights.Insert("ExternalConnection",                     NStr("en='External connection';ru='Внешнее соединение';vi='Liên kết ngoài'"));
	Rights.Insert("Automation",                            NStr("en='Automation';ru='Automation';vi='Automation'"));
	Rights.Insert("InteractiveOpenExtDataProcessors", NStr("en='Interactive opening of external data processors';ru='Интерактивное открытие внешних обработок';vi='Mở trực tác bộ xử lý ngoài'"));
	Rights.Insert("InteractiveOpenExtReports",   NStr("en='Interactive opening of external reports';ru='Интерактивное открытие внешних отчетов';vi='Mở trực tác báo cáo ngoài'"));
	Rights.Insert("AllFunctionsMode",                       NStr("en='All functions mode';ru='Режим все функции';vi='Chế độ tất cả chức năng'"));
