...
Procedure Select(Command)
	If BeginOfPeriod > EndOfPeriod Then
		CommonUseClientServer.MessageToUser(NStr("en='Period start date is more than the period end date';ru='Дата начала периода больше чем дата окончания периода';vi='Ngày đầu kỳ lớn hơn ngày cuối kỳ'"), , "BeginOfPeriod");
		Return;
	EndIf;
