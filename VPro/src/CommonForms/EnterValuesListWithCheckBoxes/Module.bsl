...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Title = NStr("en='List of selected items';ru='Список выбранных';vi='Danh sách được chọn'") + " (" + FieldPresentation + ")";
...
Procedure ListBeforeRowChange(Item, Cancel)
	...
	ListItemPriorToChange.Identifier = RowIdentifier;
...
Procedure ListBeforeEditingCompletion(Item, NewRow, CancelStartEditing, CancelEndEditing)
	...
	HasInformation = (ListItemPriorToChange <> Undefined AND ListItemPriorToChange.Identifier = RowIdentifier);
