...
Procedure SetFilterByResponsible()
	...
	Items.ResponsiblePresentation.Title = NStr("en='Responsible person: ';ru='Ответственное лицо: ';vi='Chịu trách nhiệm:'") + StringResponsible;
...
Procedure ClearFilterByResponsible()
	...
	Items.ResponsiblePresentation.Title = NStr("en='Responsible person: <for all>';ru='Ответственный: <по всем>';vi='Chịu trách nhiệm: <theo tất cả>'");
