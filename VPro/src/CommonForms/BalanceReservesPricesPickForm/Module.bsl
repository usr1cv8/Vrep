...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If ValueIsFilled(Currency) Then
		...
		NewHeaderRow 						= NStr("en='Goods are picked to the amount of (%InCurrency%)';ru='Товаров подобрано на сумму (%ВВалюте%)';vi='Hàng hóa đã chọn có số tiền (%InCurrency%)'");
...
Procedure CompanyOnChange(Item)
	...
	Else
		...
		Message.Text 		= NStr("en='Fill in company to update form data';ru='Для обновление данных формы заполните организацию';vi='Để cập nhật dữ liệu của biểu mẫu, hãy điền doanh nghiệp'");
