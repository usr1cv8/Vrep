...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If RunMode = Enums.InfobaseUsageModes.Demo Then
		Raise(NStr("en='New users cannot be added in the demo mode';ru='В демонстрационном режиме не доступно добавление новых пользователей';vi='Trong chế độ minh họa không sử dụng được tính năng thêm người sử dụng mới'"));
	EndIf;
