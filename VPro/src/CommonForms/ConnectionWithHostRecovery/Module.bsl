...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not ValueIsFilled(MasterNode) Then
		Raise NStr("en='Main node is not saved.';ru='Главный узел не сохранен.';vi='Nút chính chưa được lưu.'");
	EndIf;
	
	If ExchangePlans.MasterNode() <> Undefined Then
		Raise NStr("en='Main node is set.';ru='Главный узел установлен.';vi='Đã thiết lập nút chính.'");
	EndIf;
