...
Procedure MetadataObjectTreeFill()
	...
	CollectionsOfMetadataObjects_NewRow("Subsystems",                   NStr("en='Subsystems';ru='Подсистемы';vi='Phân hệ'"),                     35, 36, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonModules",                  NStr("en='Common modules';ru='Общие модули';vi='Mô-đun chung'"),                   37, 38, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("SessionParameters",              NStr("en='Session parameters';ru='Параметры сеанса';vi='Tham số phiên làm việc'"),               39, 40, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Roles",                         NStr("en='Roles';ru='Роли';vi='Vai trò'"),                           41, 42, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ExchangePlans",                  NStr("en='Exchange plans';ru='Планы обмена';vi='Sơ đồ trao đổi'"),                   43, 44, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("FilterCriteria",               NStr("en='Filter criteria';ru='Критерии отбора';vi='Thể loại lọc'"),                45, 46, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("EventSubscriptions",            NStr("en='Subscription to events';ru='Подписки на события';vi='Theo dõi sự kiện'"),            47, 48, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ScheduledJobs",          NStr("en='Scheduled jobs';ru='Регламентные задания';vi='Nhiệm vụ thường kỳ'"),           49, 50, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("FunctionalOptions",          NStr("en='Functional options';ru='Функциональные опции';vi='Tùy chọn chức năng'"),           51, 52, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("FunctionalOptionsParameters", NStr("en='Functional option parameters';ru='Параметры функциональных  опций';vi='Tham số tùy chọn chức năng'"), 53, 54, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("SettingsStorages",            NStr("en='Setting storage';ru='Хранилища настроек';vi='Kho chứa tùy chỉnh'"),             55, 56, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonForms",                   NStr("en='Common forms';ru='Общие формы';vi='Biểu mẫu chung'"),                    57, 58, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonCommands",                 NStr("en='Common commands';ru='Общие команды';vi='Lệnh chung'"),                  59, 60, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommandGroups",                 NStr("en='Command groups';ru='Группы команд';vi='Nhóm lệnh'"),                  61, 62, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Interfaces",                   NStr("en='Interfaces';ru='Интерфейсы';vi='Giao diện'"),                     63, 64, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonTemplates",                  NStr("en='Common templates';ru='Общие макеты';vi='Khuôn in chung'"),                   65, 66, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CommonPictures",                NStr("en='Common pictures';ru='Общие картинки';vi='Hình vẽ chung'"),                 67, 68, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("XDTOPackages",                   NStr("en='XDTO-packages';ru='XDTO-packages';vi='XDTO-packages'"),                    69, 70, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("WebServices",                   NStr("en='Web-Services';ru='Web-Services';vi='Web-Services'"),                    71, 72, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("WSReferences",                     NStr("en='WS references';ru='WS-references';vi='WS references'"),                      73, 74, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Styles",                        NStr("en='Styles';ru='Стили';vi='Phong cách'"),                          75, 76, True, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Languages",                        NStr("en='Languages';ru='Языки';vi='Ngôn ngữ'"),                          77, 78, True, CollectionsOfMetadataObjects);
	
	CollectionsOfMetadataObjects_NewRow("Constants",                    NStr("en='Constants';ru='Константы';vi='Hằng'"),                      PictureLib.Constant,              PictureLib.Constant,                    False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Catalogs",                  NStr("en='Catalogs';ru='Справочники';vi='Danh mục'"),                    PictureLib.Catalog,             PictureLib.Catalog,                   False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Documents",                    NStr("en='Documents';ru='Документы';vi='Chứng từ'"),                      PictureLib.Document,               PictureLib.DocumentObject,               False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("DocumentJournals",            NStr("en='Document logs';ru='Журналы документов';vi='Nhật ký chứng từ'"),             PictureLib.DocumentJournal,       PictureLib.DocumentJournal,             False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Enums",                 NStr("en='Transfers';ru='Перечисления';vi='Chuyển khoản'"),                   PictureLib.Enum,           PictureLib.Enum,                 False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Reports",                       NStr("en='Reports';ru='Отчеты';vi='Báo cáo'"),                         PictureLib.Report,                  PictureLib.Report,                        False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("DataProcessors",                    NStr("en='Data processors';ru='Обработки';vi='Bộ xử lý'"),                      PictureLib.DataProcessor,              PictureLib.DataProcessor,                    False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ChartsOfCharacteristicTypes",      NStr("en='Charts of characteristic types';ru='Планы видов характеристик';vi='Hệ thống dạng đặc tính'"),      PictureLib.ChartOfCharacteristicTypes, PictureLib.ChartOfCharacteristicTypesObject, False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ChartsOfAccounts",                  NStr("en='Charts of accounts';ru='Планы счетов';vi='Hệ thống tài khoản'"),                   PictureLib.ChartOfAccounts,             PictureLib.ChartOfAccountsObject,             False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("ChartsOfCalculationTypes",            NStr("en='Charts of characteristic types';ru='Планы видов характеристик';vi='Hệ thống dạng đặc tính'"),      PictureLib.ChartOfCharacteristicTypes, PictureLib.ChartOfCharacteristicTypesObject, False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("InformationRegisters",             NStr("en='Information registers';ru='Регистры сведений';vi='Biểu ghi thông tin'"),              PictureLib.InformationRegister,        PictureLib.InformationRegister,              False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("AccumulationRegisters",           NStr("en='Accumulation registers';ru='Регистры накопления';vi='Biểu ghi tích lũy'"),            PictureLib.AccumulationRegister,      PictureLib.AccumulationRegister,            False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("AccountingRegisters",          NStr("en='Accounting registers';ru='Регистры бухгалтерии';vi='Biểu ghi kế toán'"),           PictureLib.AccountingRegister,     PictureLib.AccountingRegister,           False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("CalculationRegisters",              NStr("en='Calculation registers';ru='Регистры расчета';vi='Biểu ghi tính toán'"),               PictureLib.CalculationRegister,         PictureLib.CalculationRegister,               False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("BusinessProcesses",               NStr("en='Business processes';ru='Деловые процессы';vi='Quy trình nghiệp vụ'"),                PictureLib.BusinessProcess,          PictureLib.BusinessProcessObject,          False, CollectionsOfMetadataObjects);
	CollectionsOfMetadataObjects_NewRow("Tasks",                       NStr("en='Tasks';ru='Задания';vi='Nhiệm vụ'"),                         PictureLib.Task,                 PictureLib.TaskObject,                 False, CollectionsOfMetadataObjects);
