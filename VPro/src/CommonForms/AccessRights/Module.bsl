...
Procedure ExcludeFromGroup(Command)
	...
	If Not ValueIsFilled(CurrentAccessGroup) Then
		ShowMessageBox(, NStr("en='Access group is not selected.';ru='Группа доступа не выбрана.';vi='Nhóm truy cập chưa chọn.'"));
		Return;
	EndIf;
...
"Редактировать группу доступа могут ответственный за участников группы доступа и администратор.';vi='Không đủ quyền để soạn nhóm truy cập.'"));
		Return;
	EndIf;
...
"пользователь не ответственный за участников группы доступа и не полноправный администратор.';vi='Không thể đưa"
"người sử dụng"
"vào nhóm truy cập, bởi vì người sử dụng"
"hiện tại không phải là người chịu trách nhiệm những người tham gia nhóm truy cập và không phải là người quản trị toàn quyền.'");
		Else
			ErrorDescription = NStr("en='It is not possible to"
...
"пользователь не ответственный за участников группы доступа и не полноправный администратор.';vi='Không thể loại bỏ"
"người sử dụng"
"khỏi nhóm truy cập, bởi vì người sử dụng"
"hiện tại không phải là người chịu trách nhiệm đối với người tham gia nhóm truy cập và là người quản trị không toàn quyền.'");
		EndIf;
		Return;
	EndIf;
...
"пользователя из группы доступа, так как он включен в нее косвенно.';vi='Không thể loại bỏ"
"người sử dụng khỏi nhóm truy cập, bởi vì người này đã được đưa vào nhóm một cách gián tiếp.'");
		Return;
	EndIf;
