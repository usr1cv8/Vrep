...
Procedure CheckFillOfFormAttributes(Cancel)
	...
	If Not ValueIsFilled(ExchangeRate) Then
		Message = New UserMessage();
		Message.Text = NStr("en='Zero exchange rate of the document is found.';ru='Обнаружен нулевой курс валюты документа!';vi='Tìm thấy tỷ giá hối đoái bằng 0 trong chứng từ!'");
