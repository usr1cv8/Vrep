...
""
"Не найдена подчиненная таблица ""%1"".';vi='Lỗi"
"trong thủ tục OnFillingAccessRightDependencies của mô đun chung AccessManagementOverridable."
""
"Chưa tìm thấy bảng trực thuộc ""%1"".'"),
...
"в процедуре ПриЗаполненииЗависимостейПравДоступа общего модуля УправлениеДоступомПереопределяемый."
""
"Не найдена ведущая таблица ""%1"".';vi='Lỗi"
"trong thủ tục OnFillingAccessRightDependencies của mô đun chung AccessManagementOverridable."
""
"Chưa tìm thấy bảng chính ""%1"".'"),
				String.MasterTable);
		EndIf;
