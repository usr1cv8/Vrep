...
Procedure BeforeWrite(Cancel, Replacing)
	...
	TextSeries			= NStr("en=', series: %1';ru=', серия: %1';vi=', ký hiệu: %1'");
	TextNumber			= NStr("en=', No.%1';ru=', № %1';vi=', số %1'");
	TextIssuanceDate	= NStr("en=', issued: %1';ru=', выдан: %1 года';vi=', ngày cấp: %1'");
	TextValidityPeriod	= NStr("en=', valid till: %1';ru=', действует до: %1 года';vi=', có giá trị đến: %1'");
	TextDepartmentCode	= NStr("en=', dep. No.%1';ru=', № подр. %1';vi=', mã nơi cấp %1'");
...
Procedure OnWrite(Cancel, Replacing)
	...
	MessageText = NStr("en='ID document of individual %2 has been already entered as of 1%.';ru='На %1 у физлица %2 уже введен документ, удостоверяющий личность.';vi='Đối với %1 của cá nhân %2 đã nhập chứng từ, chứng minh thư.'");
