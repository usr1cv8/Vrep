...
Procedure FillPrintFormsTemplatesTable()
	...
	For Each MetadataObjectTemplate IN Metadata.CommonTemplates Do
		...
		If TemplateType = Undefined Then
			Continue;
		EndIf;
		AddDetailsTemplate("CommonTemplate." + MetadataObjectTemplate.Name, MetadataObjectTemplate.Synonym, NStr("en='Common template';ru='Общий шаблон';vi='Khuôn mẫu chung'"), TemplateType);
	EndDo;
