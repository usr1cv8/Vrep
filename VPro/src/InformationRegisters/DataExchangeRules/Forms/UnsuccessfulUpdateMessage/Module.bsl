...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If RulesFromFile.ConversionRules AND RulesFromFile.RegistrationRules Then
		RulesType = NStr("en='conversions and registrations';ru='конвертации и регистрации';vi='chuyển đổi và ghi nhận'");
	ElsIf RulesFromFile.ConversionRules Then
		RulesType = NStr("en='conversion';ru='преобразование';vi='chuyển đổi'");
	ElsIf RulesFromFile.RegistrationRules Then
		RulesType = NStr("en='registration';ru='регистрационный';vi='số đăng ký'");
	EndIf;
