...
Function AuthorizationKey(Val Resolution) Export
	...
	If StrLen(Key) > 32 Then
		Raise NStr("en='Key length exceeds the allowed one';ru='Превышение длины ключа';vi='Tăng chiều dài khóa'");
	EndIf;
...
"%2 - ТипВладельца: %3 - ИдентификаторВладельца: %4 - КлючРазрешения: %5.';vi='Sao chép"
"sự cho phép"
"theo các trường khóa:"
"- SowtwareModuleType:"
"%1 - SowtwareModuleIdentifier:"
"%2 - OwnerType: %3 - OwnerIdentifier: %4 - PermissionKey: %5.'"),
...
"%2 - ТипВладельца: %3 - ИдентификаторВладельца: %4 - КлючРазрешения: %5.';vi='Vị trí"
"cho phép"
"theo các khóa:"
"%1 - ProgramModuleID:"
"%2 - OwnerType:"
