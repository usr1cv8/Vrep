...
Function StatusOfSession(Val Session) Export
	...
	If QueryResult.IsEmpty() Then
		MessageString = NStr("en='Message exchange session of the ""%1"" application was not found.';ru='Сессия обмена сообщениями системы ""%1"" не найдена.';vi='Không tìm thấy phiên trao đổi thông điệp của hệ thống ""%1"".'");
