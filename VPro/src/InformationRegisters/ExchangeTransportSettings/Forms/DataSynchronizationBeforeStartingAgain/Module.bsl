...
"""%1""."
"Техническую информацию см. в <a href = ""ЖурналРегистрации"">Журнале регистрации</a>.';vi='Không thể cài đặt bản cập nhật chương trình đã nhận từ"
"""%1""."
"Thông tin kỹ thuật xem trong <a href = ""ЖурналРегистрации"">Nhật ký sự kiện</a>.'");
...
"Требуется открыть конфигуратор и обновить конфигурацию базы данных.';vi='Đã nhận từ nút chính các thay đổi mà vẫn chưa được áp dụng."
"Cần mở bộ thiết kế và cập nhật cấu hình cơ sở dữ liệu.'");
...
"Требуется открыть конфигуратор и обновить конфигурацию базы данных.';vi='Từ nút chính nhận các thay đổi mà cần áp dụng chúng."
"Cần mở bộ thiết kế và cập nhật cấu hình cơ sở dữ liệu.'");
	Else
...
"Подробности см. в журнале регистрации.';vi='Việc nhận dữ liệu từ nút chính đã kết thúc có lỗi."
