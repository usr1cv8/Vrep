...
Function TransportSettings(Val CorrespondentEndPoint) Export
	...
	If QueryResult.IsEmpty() Then
		Raise StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en='Connection settings for the endpoint %1 are not specified.';ru='Не заданы настройки подключения для конечной точки %1.';vi='Chưa thiết lập tùy chỉnh kết nối cho điểm cuối %1.'"),
