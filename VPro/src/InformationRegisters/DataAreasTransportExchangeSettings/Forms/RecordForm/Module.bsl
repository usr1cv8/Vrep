...
Procedure CheckConnection(TransportKindString)
	...
	WarningText = ?(Cancel, NStr("en='Cannot connect.';ru='Не удалось установить подключение.';vi='Không thể thiết lập kết nối.'"), NStr("en='Connection has been successfully established.';ru='Подключение успешно установлено.';vi='Kết nối đã thiết lập thành công.'"));
