...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Parameters.Property("Filter") AND Parameters.Filter.Property("ProductsAndServices") Then
		...
		If ProductsAndServices.ProductsAndServicesType <> Enums.ProductsAndServicesTypes.InventoryItem Then
			...
			AutoTitle = False;
			Title = NStr("en='Counterparty prices can be entered only for products and services with the Inventory type';ru='Цены контрагентов можно вводить только для номенклатуры с типом Запас';vi='Chỉ có thể nhập đơn giá của đối tác đối với mặt hàng có kiểu Vật tư'");
