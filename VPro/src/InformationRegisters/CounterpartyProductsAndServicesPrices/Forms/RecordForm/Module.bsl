...
Procedure PriceKindStartChoice(Item, ChoiceData, StandardProcessing)
	...
	If Not ValueIsFilled(Counterparty) Then
		...
		MessageText = NStr("en='Specify the counterparty to select the price kind.';ru='Укажите контрагента для выбора видов цен.';vi='Hãy chỉ ra đối tác để chọn dạng giá.'");
