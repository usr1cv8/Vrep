...
"Для объекта"
"метаданных ""%1"""
"не найден идентификатор в справочнике ""Идентификаторы объектов метаданных"".';vi='Lỗi khi thực hiện hàm CommonUse.MetadataObjectID()."
""
"Đối với đối tượng"
"metadata ""%1"""
"chưa tìm thấy tên trong danh mục ""Tên đối tượng metadata"".'")
