...
Function PublicIdentifierByObjectRef(InfobaseNode, ObjectReference) Export
	...
	ElsIf Selection.Count() > 1 Then
		Raise StringFunctionsClientServer.SubstituteParametersInString(
				NStr("en='Several unique IDs are assigned for the <%1> reference and <%2> node.';ru='Для ссылки <%1> и узла <%2> назначено несколько уникальных идентификаторов.';vi='Đối với tham chiếu <%1> và nút <%2> đã xác định một số tên duy nhất.'"),
