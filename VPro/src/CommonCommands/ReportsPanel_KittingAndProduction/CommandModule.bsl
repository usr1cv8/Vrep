...
Procedure CommandProcessing(CommandParameter, CommandExecuteParameters)
	...
	ReportsVariantsClient.ShowReportsPanel("KittingAndProduction", CallParameters, NStr("en='Production reports';ru='Отчеты по производству';vi='Báo cáo theo sản xuất'"));
