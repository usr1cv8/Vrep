...
"сведения о всех пользователях, включая настройки для входа (если указаны).';vi='Đưa ra thông tin chi tiết"
"về tất cả người sử dụng mà bao gồm tùy chỉnh để đăng nhập (nếu đã chỉ ra).'");
...
"сведения о пользователях, включая настройки для входа (если указаны).';vi='Đưa ra thông tin chi tiết"
"về người sử dụng mà bao gồm tùy chỉnh để đăng nhập (nếu đã chỉ ra).'");
...
"о внешних пользователях, включая настройки для входа (если указаны).';vi='Đưa ra thông tin chi tiết"
"về người sử dụng ngoài mà bao gồm tùy chỉnh để đăng nhập (nếu đã chỉ ra)."
"'");
	VariantSettings.FunctionalOptions.Add("UseExternalUsers");
EndProcedure
