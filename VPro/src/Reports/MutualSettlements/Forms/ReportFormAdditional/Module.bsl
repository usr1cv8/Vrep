...
Procedure SetPeriod(PeriodName, Direction)
	...
	Result.Area(2,2,2,2).Text 		= NStr("en='The report is not generated. Click ""Run report"" to generate the report.';ru='Отчет не сформирован. Нажмите ""Сформировать"" для получения отчета.';vi='Chưa lập báo cáo. Hãy nhấn nút ""Lập báo cáo"" để nhận báo cáo.'");
