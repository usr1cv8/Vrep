...
Function TitleByLinksSet(Val RefsSet)
	...
	If TypeOf(RefsSet) = Type("ValueList") Then
		...
		If TotalRefs >= 0 Then
			...
			If SameType Then
				Result = StrReplace(NStr("en='Usage locations %1';ru='Места использования %1';vi='Nơi sử dụng %1'"), "%1", 
	...
	If Result = Undefined Then
		Result = NStr("en='Item usage locations';ru='Места использования элементов';vi='Nơi sử dụng phần tử'");
	EndIf;
