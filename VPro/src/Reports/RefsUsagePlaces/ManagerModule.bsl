...
Procedure ConfigureReportsVariants(Settings, ReportSettings) Export
	...
	VariantSettings.Description = NStr("en='Search for usage locations of application objects.';ru='Поиск мест использования объектов приложения.';vi='Tìm kiếm chỗ sử dụng đối tượng ứng dụng.'");
EndProcedure
