...
Procedure OnComposeResult(ResultDocument, DetailsData, StandardProcessing)
	...
	If Not StartDate = Date(1,1,1)
		...
		Message.Text	 	= NStr("en='Begin of the period can not be greater than end of period';vi='Đầu kỳ không được lớn hơn cuối kỳ'");
		Message.Message();
...
Function GenerateReportTORG29(StartDate, EndDate, StructuralUnit, Company, ReportNumber)
	...
	TemplateArea.Parameters.StartDate = NStr("en='Balance on ';vi='Báo cáo ngày ';") + Format(StartDate, "DLF=D");
	...
	TemplateArea.Parameters.EndDate = NStr("en='Balance on ';vi='Báo cáo ngày ';") + Format(EndDate, "DLF=D");
