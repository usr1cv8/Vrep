...
Procedure OnComposeResult(ResultDocument, DetailsData, StandardProcessing)
	...
	If ParameterPlanningPeriod = Undefined
		...
		Message.Text	 	= NStr("en='Before generating the report, fill in the ""Planning period"" parameter value.';ru='Перед формированием отчета значение параметра ""Период планирования"" должно быть заполнено.';vi='Trước khi lập báo cáo, cần phải điền giá trị tham số ""Kỳ kế hoạch"".'");
		Message.Message();
