	...
	Try
		...
		If MessageChannel = "DataExchange\Application\ExchangeCreation" Then
			...
			CreateDataExchangeInInfobase(
									...
									MessageBody.FilterSettingsAtNode,
...
//
Procedure CreateDataExchangeInInfobase(Sender, Settings, FilterSettingsAtNode, DefaultValuesAtNode, ThisNodeCode, NewNodeCode)
	...
	Try
		...
		FilterSettingsAtNode      = New Structure;
...
Function EventLogMonitorMessageTextSendMessages()
	...
	Return NStr("en='Send messages';ru='Отправка сообщений';vi='Gửi thông báo'", CommonUseClientServer.MainLanguageCode());
