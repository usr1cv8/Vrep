...
Function TextForAdministrator() Export
	...
	Return NStr("en='For the administrator:';ru='Для администратора:';vi='Đối với người quản trị:'");
...
Function EventLogMonitorEvent() Export
	...
	Return NStr("en='User work completion';ru='Завершение работы пользователей';vi='Kết thúc công việc của người sử dụng'", CommonUseClientServer.MainLanguageCode());
