...
Function AttributeCompanyIsAvailable(Object)
	...
	If   (CommonUse.ThisIsCatalog(ObjectMetadata)
		...
		If AttributeCompany = Undefined Then
			...
			MessageString = NStr("en='Attribute with the ""%2"" name is not defined for metadata object %1.';ru='Для объекта метаданных %1 не определен реквизит с именем %2.';vi='Đối với đối tượng metadata %1 chưa xác định mục tin từ tên gọi %2.'");
