...
Procedure AfterGenerating(ReportForm, ReportCreated) Export
	
EndProcedure

#Region UniersalReport

Procedure SpreadsheetDocumentChoiceProcessing(ReportForm, Item, Area, StandardProcessing) Export
