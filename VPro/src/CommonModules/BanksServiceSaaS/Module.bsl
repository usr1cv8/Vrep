...
Procedure ImportRFBanksClassifier() Export
	...
	If Descriptors.Descriptor.Count() < 1 Then
		Raise(NStr("en='There is no data of the RFBanks kind in the service manager';ru='В менеджере сервиса отсутствуют данные вида ""БанкиРФ""';vi='Trong bộ quản lý không có dữ liệu dạng ""Ngân hàng Việt Nam""'"));
	EndIf;
