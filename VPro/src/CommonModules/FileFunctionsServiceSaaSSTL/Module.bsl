...
"не может быть обработан обработчиком ФайловыеФункцииСлужебныйВМоделиСервисаБТС.ПередВыгрузкойОбъекта()!';vi='Đối tượng metadata %1"
"không thể được xử lý bởi hàm xử lý ФайловыеФункцииСлужебныйВМоделиСервисаБТС.ПередВыгрузкойОбъекта()!'", Metadata.DefaultLanguage.LanguageCode),
