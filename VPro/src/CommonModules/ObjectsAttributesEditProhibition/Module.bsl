...
Procedure PrepareForm(Form, Refs, GroupForProhibitionButton, ProhibitionButtonTitle)
	...
	If Users.RolesAvailable("EditObjectAttributes")
	   ...
	   AND Not AllAttributesWithoutEditingRight Then
		...
		Command.Title = ?(IsBlankString(ProhibitionButtonTitle), NStr("en='Allow editing attributes';ru='Разрешить редактирование реквизитов';vi='Cho phép soạn mục tin '"), ProhibitionButtonTitle);
