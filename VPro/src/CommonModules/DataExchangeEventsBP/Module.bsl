...
Procedure ExchangeSmallBusinessAccounting30BeforeWrite(Source, Cancel) Export
	...
	DataExchangeEvents.ObjectsRegistrationMechanismBeforeWrite("ExchangeCompanyManagementAccounting", Source, Cancel);
...
Procedure ExchangeSmallBusinessAccounting30BeforeWriteDocument(Source, Cancel, WriteMode, PostingMode) Export
	...
	DataExchangeEvents.ObjectsRegistrationMechanismBeforeWriteDocument("ExchangeCompanyManagementAccounting", Source, Cancel, WriteMode, PostingMode);
...
Procedure ExchangeSmallBusinessAccounting30BeforeWriteRegister(Source, Cancel, Replacing) Export
	...
	DataExchangeEvents.ObjectsRegistrationMechanismBeforeWriteRegister("ExchangeCompanyManagementAccounting", Source, Cancel, Replacing);
...
Procedure ExchangeSmallBusinessAccounting30BeforeDelete(Source, Cancel) Export
	...
	DataExchangeEvents.ObjectsRegistrationMechanismBeforeDelete("ExchangeCompanyManagementAccounting", Source, Cancel);
