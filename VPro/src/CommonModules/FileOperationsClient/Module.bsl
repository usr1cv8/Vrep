...
Procedure OpenScanSettingsForm() Export
	...
	If CommonUseClientServer.IsLinuxClient() Then
		MessageText = NStr("en='Scanning is not supported in client under OS Linux.';ru='Сканирование не поддерживается в клиенте под управлением ОС Linux.';vi='Không hỗ trợ quét ảnh trong Client dưới hệ điều hành Linux'");
...
""
"Продолжить?';vi='Bạn đã chiếm một hoặc nhiều tệp để soạn."
""
"Tiếp tục?'");
