...
Procedure Sign(DataDescription, Form = Undefined, ResultProcessing = Undefined) Export
	...
	ServerParameters.Insert("Operation",            NStr("en='Data signing';ru='Подписание данных';vi='Ký dữ liệu'"));
...
Procedure Encrypt(DataDescription, Form = Undefined, ResultProcessing = Undefined) Export
	...
	ServerParameters = New Structure;
	ServerParameters.Insert("Operation",            NStr("en='Data encryption';ru='Шифрование данных';vi='Mã hóa dữ liệu'"));
	ServerParameters.Insert("DataTitle",     NStr("en='Data';ru='Данные';vi='Dữ liệu'"));
...
Procedure Decrypt(DataDescription, Form = Undefined, ResultProcessing = Undefined) Export
	...
	ServerParameters = New Structure;
	ServerParameters.Insert("Operation",            NStr("en='Data decryption';ru='Расшифровка данных';vi='Giải mã dữ liệu'"));
	ServerParameters.Insert("DataTitle",     NStr("en='Data';ru='Данные';vi='Dữ liệu'"));
	ServerParameters.Insert("FilterCertificates");
...
Procedure InformAboutSigningAnObject(DataPresentation, DataSet = False, FromFile = False) Export
	...
	If FromFile Then
		If DataSet Then
			MessageText = NStr("en='Signatures from files added:';ru='Добавлены подписи из файлов:';vi='Đã thêm chữ ký từ tệp:'");
		Else
			MessageText = NStr("en='Signature from file added:';ru='Добавлена подпись из файла:';vi='Đã thêm chữ ký từ tệp:'");
		EndIf;
	Else
		If DataSet Then
			MessageText = NStr("en='Digitally signed:';ru='Установлены подписи:';vi='Đã cài đặt chữ ký:'");
		Else
			MessageText = NStr("en='Digitally signed:';ru='Установлена подпись:';vi='Đã cài đặt chữ ký:'");
		EndIf;
	EndIf;
...
Procedure InformAboutObjectEncryption(DataPresentation, DataSet = False) Export
	...
	MessageText = NStr("en='Encrypted:';ru='Выполнено шифрование:';vi='Đã giải mã:'");
...
Procedure InformAboutObjectDecryption(DataPresentation, DataSet = False) Export
	...
	MessageText = NStr("en='Decrypted:';ru='Выполнена расшифровка:';vi='Đã giải mã:'");
