...
Function MessageAboutPrintingCommandPurpose(PrintingObjectsTypes) Export
	MessageText = NStr("en='The selected print command is intended for documents';ru='Выбранная команда печати предназначена для документов';vi='Lệnh in đã chọn được dùng cho chứng từ.'") 
