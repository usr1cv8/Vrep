...
"получить текущего пользователя в сеансе внешнего пользователя.';vi='Không thể"
"nhận người sử dụng hiện tại trong phiên làm việc của người sử dụng ngoài.'");
	EndIf;
...
"получить текущего внешнего пользователя в сеансе пользователя.';vi='Không thể"
"nhận người sử dụng ngoài hiện tại trong phiên làm việc của người sử dụng.'");
	EndIf;
...
#If Server OR ThickClientOrdinaryApplication OR ExternalConnection Then
	Return UsersServiceReUse.IsExternalUserSession();
#Else
