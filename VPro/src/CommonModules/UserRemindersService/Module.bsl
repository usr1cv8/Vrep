...
Function GetStandardSchedulesToRemind() Export
	...
	Result.Insert(NStr("en='on Mondays at 9 a.m.';ru='по понедельникам, в 9:00';vi='vào thứ hai, lúc 9:00'"), Schedule);
	...
	WeekDays.Add(5);
	Schedule.WeekDays = WeekDays;
	Result.Insert(NStr("en='on Fridays at 3 p.m.';ru='по пятницам, в 15:00';vi='vào thứ sáu, lúc 15:00'"), Schedule);
	...
	Schedule.WeeksPeriod = 1;
	Schedule.BeginTime = '00010101090000';
	Result.Insert(NStr("en='every day at 9:00';ru='каждый день, в 9:00';vi='hàng ngày, vào lúc 9:00'"), Schedule);
