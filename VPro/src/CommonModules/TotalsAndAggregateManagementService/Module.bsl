...
Procedure AtFillingToDoList(CurrentWorks) Export
	...
	Prototype.Presentation = NStr("en='Optimize application';ru='Оптимизировать программу';vi='Tối ưu hóa chương trình'");
...
"Обязательная ежемесячная процедура, может занять некоторое время.';vi='Tăng tốc độ kết chuyển chứng từ và lập báo cáo."
"Thủ tục bắt buộc hàng tháng có thể mất một khoảng thời gian.'");
...
Function ScheduleTasks1Default(Val Name)
	...
	Else
		MessagePattern = NStr("en='Unknown job name %1';ru='Неизвестное имя задания %1';vi='Tên nhiệm vụ không xác định %1'");
