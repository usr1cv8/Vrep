...
//
// Example:
//  SubstituteParametersInString(NStr("en='%1 went to %2';vi='%1 đến %2'"), "John", "a zoo") = "John went to a zoo".
//
...
//
// String = SubstituteParametersInString(NStr("en='%1 went to %2';vi='%1 đến %2'"), ParameterArray);
//
