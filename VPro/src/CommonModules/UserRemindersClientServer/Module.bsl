...
Function TimePresentation(Val Time, FullPresentation = True, OutputSeconds = True) Export
	...
	DaysRepresentation	= NStr("en='day';ru='дне';vi='ng'")    + "," + NStr("en='days';ru='дня';vi='ngày'")     + "," + NStr("en='days';ru='дня';vi='ngày'");
	HoursRepresentation	= NStr("en='hour';ru='час';vi='giờ'")     + "," + NStr("en='hours';ru='часа';vi='giờ'")    + "," + NStr("en='Hours';ru='часы';vi='giờ công'");
	MinutesRepresentation	= NStr("en='minute';ru='минуту';vi='phút'")  + "," + NStr("en='minutes';ru='минуты';vi='phút'")  + "," + NStr("en='minutes';ru='минут';vi='phút'");
	SecondsRepresentation	= NStr("en='second';ru='секунду';vi='giây'") + "," + NStr("en='Seconds';ru='секунды';vi='giây'") + "," + NStr("en='Seconds';ru='секунды';vi='giây'");
...
Function ReplaceUnitDimensionsOnFactor(Val Unit)
	...
	If FirstThreeSymbols = NStr("en='week';ru='неделю';vi='tuần'") Or FirstThreeSymbols = NStr("en='n';ru='н';vi='t'") Then
		Result = 60*60*24*7;
	ElsIf FirstThreeSymbols = NStr("en='day';ru='дне';vi='ng'") 
		  Or FirstThreeSymbols = NStr("en='day';ru='дне';vi='ng'")
		  Or FirstThreeSymbols = NStr("en='days';ru='дня';vi='ngày'")
		  Or FirstThreeSymbols = NStr("en='days';ru='дня';vi='ngày'")
		  Or FirstThreeSymbols = NStr("en='days';ru='дн';vi='ngày'") Then
		Result = 60*60*24;
	ElsIf FirstThreeSymbols = NStr("en='hour';ru='час';vi='giờ'") Or FirstThreeSymbols = NStr("en='h';ru='ch';vi='ch'") Then
		Result = 60*60;
	ElsIf FirstThreeSymbols = NStr("en='min';ru='мин';vi='phút'") Or FirstThreeSymbols = NStr("en='m';ru='m';vi='m'") Then
		Result = 60;
	ElsIf FirstThreeSymbols = NStr("en='sec';ru='сек';vi='giâ'") Or FirstThreeSymbols = NStr("en='From';ru='Списать из';vi='Từ'") Then
		Result = 1;
	EndIf;
