...
"выполнить операцию отключения в приложении сервиса и провести синхронизацию данных автономного рабочего места с сервисом.';vi='Báo cáo hoặc bộ xử lý bổ sung %1 đã được kết nhập từ Service và không thể bị ngắt khỏi bàn làm việc độc lập!"
"Để xóa báo cáo hoặc bộ xử lý bổ sung, cần"
"thực hiện thao tác tắt trong ứng dụng Service và đồng bộ hóa dữ liệu của bàn làm việc độc lập với Service.'"),
				Source.Description);
