...
"Document %1."
"None of the goods in the document with the option <Write out the guarantee card>';ru='__________________"
"Документ %1."
"В документе нет товаров с опцией <Выписывать гарантийный талон>';vi='__________________"
"Chứng từ %1."
"Trong chứng từ không có hàng hóa với tùy chọn <Viết thẻ bảo hành>'");
	...
	TemplateArea.Parameters.HeaderText = NStr("en='Guarantee card  № ';vi='Thẻ bảo hành số ';")
		+ DocumentNumber
		+ NStr("en=' dated ';vi=' ngày ';")
