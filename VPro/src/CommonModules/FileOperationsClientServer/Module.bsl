...
"т.к. он помечен на удаление.';vi='Không thể chiếm tệp ""%1"","
"bởi vì tệp bị đánh dấu xóa.'"),
			String(FileData.Ref));
		Return False;
	EndIf;
...
"""%2"" с %3.';vi='Người sử dụng đã chiếm tệp ""%1"""
"để soạn"
"""%2"" từ %3."
"'"),
			String(FileData.Ref),
...
Function EventLogMonitorEvent() Export
	...
	Return NStr("en='Files';ru='Файлы';vi='Tệp'", CommonUseClientServer.MainLanguageCode());
