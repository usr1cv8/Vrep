...
"сервиса требуется внедрить библиотеку ""1С:Библиотека стандартных подсистем"" версии не младше %1!';vi='Trong cấu hình chưa nhập thư viện ""1C:Thư viện các phân hệ chuẩn""."
"Nếu chưa nhập thư viện này thì không thể sử dụng cấu hình trong mô hình dịch vụ đám mây."
""
"Để sử dụng cấu hình này trên dịch vụ đám mây,"
"cần kết nhập thư viện ""1C:Thư viện các phân hệ chuẩn"" có phiên bản không thấp hơn %1!'", Metadata.DefaultLanguage.LanguageCode),
			RequiredSSLVersion());
...
""
"Используемая версия: %1, требуется версия не младше %2!';vi='Để sử dụng cấu hình trong mô hình dịch vụ đám mây với"
"phiên bản hiện tại của thư viện ""1C:Thư viện công nghệ dịch vụ"""
"cần cập nhật phiên bản thư viện đang dùng ""1C:Thư viện phân hệ chuẩn""!"
""
"Phiên bản sử dụng: %1, cần có phiên bản không dưới %2!'", Metadata.DefaultLanguage.LanguageCode),
...
Function GetWebServiceErrorDescription(ErrorInfo) Export
	...
	WriteLogEvent(NStr("en='Web service operation in progress';ru='Выполнение операции web-сервиса';vi='Thực hiện giao dịch Web-service'"), EventLogLevel.Error, , ,
