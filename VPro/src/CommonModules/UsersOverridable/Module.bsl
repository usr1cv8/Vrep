...
Procedure OnReceiveOtherSettings(UserInfo, Settings) Export
	...
	If SettingValue <> Undefined Then
		...
		InformationAboutSetting.Insert("SettingName", NStr("en='Confirmation on closing the application';ru='Подтверждение при завершении программы';vi='Xác nhận khi kết thúc chương trình'"));
...
Procedure LinkUserToEmployee(User) Export
	...
	Else
		...
		Employee = LinkedUsersTable[0].Ref;
