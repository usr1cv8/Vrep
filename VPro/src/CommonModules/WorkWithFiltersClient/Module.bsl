...
Procedure CollapseExpandFiltersPanel(Form, Visible, StructureItemNames = Undefined) Export
	...
	If StructureItemNames = Undefined Then
		Form.Items.FiltersSettingsAndExtraInfo.Visible	= Visible;
		Form.Items.DecorationExpandFilters.Visible	= Not Visible;
		Form.Items.RightPanel.Width					= ?(Visible, ?(InterfaceTaxi, 25, 24), 0);
	Else
		Form.Items[StructureItemNames.FiltersSettingsAndExtraInfo].Visible	= Visible;
