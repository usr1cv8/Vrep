		...
		If ChangesTemplates.Deleted.Count() > 0
			...
			While Selection.Next() Do
				...
				If RowTemplate = Undefined Then
					MessagePattern = NStr("en='Job template %1 was not found while updating';ru='При обновлении не найден шаблон задания %1';vi='Khi cập nhật chưa tìm thấy khuôn in xác định %1'");
