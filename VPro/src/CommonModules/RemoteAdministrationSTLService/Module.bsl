...
Function ManagingApplicationServiceUtilizedVersion(Val UserPassword = "") Export
	...
	Else
		...
		Raise StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en='Correspondent %1 does not support interface %2.';ru='Корреспондент %1 не поддерживает интерфейс %2!';vi='Dữ liệu trao đổi tin %1 không hỗ trợ giao diện %2!'"),
...
Procedure DataAreaSessionEnd(Val SessionNumber, Val UserPassword) Export
	...
	Else
		...
		Raise NStr("en='Ending sessions from applications is not supported by the current version of the managing application. Managing application update is required.';ru='Текущая версия управляющего приложения не поддерживает завершение сеанса из приложений. Необходимо обновить управлящее приложение.';vi='Phiên bản hiện tại của ứng dụng quản lý không hỗ trợ kết thúc phiên làm việc khỏi ứng dụng. Cần cập nhật ứng dụng quản lý.'");
