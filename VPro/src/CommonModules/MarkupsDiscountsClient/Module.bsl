...
Procedure OpenFormAppliedDiscounts(CurrentData, Object, Form) Export
	...
	If CurrentData <> Undefined Then
		...
		ParametersStructure.Insert("Title", NStr("en='Applied discounts (markups) for row';ru='Примененные скидки (наценки) для строки';vi='Chiết khấu (phụ thu) đã áp dụng cho dòng'"));
