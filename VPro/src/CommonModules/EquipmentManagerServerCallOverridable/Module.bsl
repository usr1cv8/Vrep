...
Procedure RefreshSuppliedDrivers() Export
	...
	// Bar code scanners
	Catalogs.HardwareDrivers.FillPredefinedItem(Enums.PeripheralDriverHandlers.Handler1CBarCodeScannersNative,  "AddIn.InputDevice", "Driver1CNativeInputDevice", False, "9.0.8.10");
	// End Barcode scanners
...
Procedure RefreshDriversConnectedEquipmentHandbook() Export
	...
	While Selection.Next() Do
		...
		If Selection.DeleteDriverHandler = Enums.PeripheralDriverHandlers.Handler1CBarCodeScannersNative
