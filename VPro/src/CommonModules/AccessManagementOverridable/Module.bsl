...
Procedure OnFillAccessKinds(AccessKinds) Export
	...
	AccessKind.Presentation    = NStr("en='Cash funds';ru='Кассы';vi='Tiền mặt'");
	AccessKind.ValuesType      = Type("CatalogRef.PettyCashes");
	
	AccessKind = AccessKinds.Add();
	AccessKind.Name = "CounterpartiesGroup";
	AccessKind.Presentation    = NStr("en='Counterparty groups';ru='Группы контрагентов';vi='Nhóm đối tác'");
	AccessKind.ValuesType      = Type("CatalogRef.Counterparties");
	AccessKind.ValueGroupType = Type("CatalogRef.CounterpartiesAccessGroups");
	
	AccessKind = AccessKinds.Add();
	AccessKind.Name = "Warehouses";
	AccessKind.Presentation    = NStr("en='Warehouses';ru='Склады';vi='Nhiều kho'");
	AccessKind.ValuesType      = Type("CatalogRef.StructuralUnits");
...
#Region Sales
	...
	ProfileDescription.Description = NStr("en='Sales';ru='Продажи';vi='Bán hàng'");
	ProfileDescription.Definition = NStr("en='Use this profile to operate with the Sales and Service sections.';ru='Под профилем осуществляется работа с разделами Продажи и Сервис.';vi='Hồ sơ này dùng cho công việc với các phần hành Bán hàng và Dịch vụ.'"
	);
	...
	// 
	ProfileDescription.AccessKinds.Add("Companies", "InitiallyAllAllowed");
	
	ProfileDescription.AccessKinds.Add("Warehouses", "InitiallyAllAllowed");
	...
	ProfileDescription.Description = NStr("en='Edit document prices (additionally)';ru='Редактирование цен документов (дополнительно)';vi='Soạn giá chứng từ (bổ sung)'");
	ProfileDescription.Definition = NStr("en='Service profile that allows you to edit prices in documents for managers.';ru='Служебный профиль, определяющий возможность редактирования цен в документах для менеджеров.';vi='Hồ sơ hệ thống, dùng để xác định khả năng soạn giá trong các chứng từ dành cho người quản lý.'"
	);
	...
	ProfileDescription.Description = NStr("en='Edit products and services (additionally)';ru='Редактирование номенклатуры (дополнительно)';vi='Soạn mặt hàng (bổ sung)'");
	ProfileDescription.Definition = NStr("en='Service profile that allows you to edit products and services for managers.';ru='Служебный профиль, определяющий возможность редактирования номенклатуры для менеджеров.';vi='Hồ sơ hệ thống, dùng để xác định khả năng soạn mặt hàng dành cho người quản lý.'"
	);
	...
	ProfileDescription.Description = NStr("en='Returns from customers (additionally)';ru='Возвраты от покупателей (дополнительно)';vi='Nhận hàng bán bị trả lại (bổ sung thêm)'");
	ProfileDescription.Definition = NStr("en='Service profile that allows you to work with returns from customers.';ru='Служебный профиль, определяющий возможность работы с возвратами от покупателей.';vi='Hồ sơ hệ thống, dùng để xác định khả năng làm việc với hàng bán bị trả lại.'"
	);
...
#Region Purchases
	...
	ProfileDescription.Description = NStr("en='Purchases';ru='Закупки';vi='Mua hàng'");
	ProfileDescription.Definition = NStr("en='Use this profile to work with the Purchases section.';ru='Под профилем осуществляется работа с разделом Закупки.';vi='Hồ sơ này dùng cho công việc với phần hành Mua hàng.'"
	);
	...
	ProfileDescription.Description = NStr("en='Returns to suppliers (additionally)';ru='Возвраты поставщикам (дополнительно)';vi='Trả lại hàng cho nhà cung cấp (bổ sung thêm)'");
	ProfileDescription.Definition = NStr("en='Service profile that allows you to work with returns to suppliers.';ru='Служебный профиль, определяющий возможность работы с возвратами поставщикам.';vi='Hồ sơ hệ thống, dùng để xác định khả năng làm việc với hàng trả lại nhà cung cấp.'"
	);
...
#Region Production
	...
	ProfileDescription.Description = NStr("en='Production';ru='Производство';vi='Sản xuất'");
	ProfileDescription.Definition = NStr("en='Use this profile to operate with the Production section.';ru='Под профилем осуществляется работа с разделом Производство.';vi='Hồ sơ này dùng cho công việc với phân hệ Sản xuất.'"
	);
...
#Region Funds
	...
	ProfileDescription.Description = NStr("en='Funds';ru='Деньги';vi='Vốn bằng tiền'");
	ProfileDescription.Definition = NStr("en='Use this profile to operate with the Funds section: bank, cash fund and payment calendar.';ru='Под профилем осуществляется работа с разделом Деньги: банк, касса и платежный календарь.';vi='Hồ sơ này dùng cho công việc với phần hành Tài chính: tiền gửi, tiền mặt và lịch thanh toán.'"
	);
	...
	ProfileDescription.Roles.Add("UsePeripherals");
	ProfileDescription.Roles.Add("DataExchangeWithMobileApplication");
	ProfileDescription.Roles.Add("AddChangeLoanManagementSubsystem");
...
#Region Salary
	...
	ProfileDescription.Description = NStr("en='Payroll';ru='Зарплата';vi='Tiền lương'");
	ProfileDescription.Definition = NStr("en='Use this profile to operate with the Payroll section: HR recordkeeping and payroll.';ru='Под профилем осуществляется работа с разделом Зарплата: кадровый учет и расчет зарплаты.';vi='Hồ sơ này dùng cho công việc với phần hành Tiền lương: kế toán nhân sự và tính lương.'"
	);
...
Procedure OnFillingKindsOfRestrictionsRightsOfMetadataObjects(Definition) Export
	...
	|Document.CustomerInvoice.Read.Companies
	|Document.CustomerInvoice.Update.Companies
