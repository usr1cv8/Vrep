...
Function GetExchangeServiceWSProxy() Export
	...
	If Result = Undefined Then
		Raise NStr("en='Error receiving data exchange web service of managing application.';ru='Ошибка получения web-сервиса обмена данными управляющего приложения.';vi='Lỗi nhận Web-service trao đổi dữ liệu ứng dụng được điều khiển.'");
	EndIf;
