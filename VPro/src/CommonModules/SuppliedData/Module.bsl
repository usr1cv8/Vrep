...
Function ProvidedDataFromCache(Val RefOrIdentifier) Export
	...
	Else
		...
		Except
			...
			WriteLogEvent(
				NStr("en='Supplied data.Receiving file from volume';ru='Поставляемые данные.Получение файла из тома';vi='Dữ liệu cài đặt.Nhận tệp từ quyển'", 
...
""
"Файл: ""%1.%2"".';vi='Lỗi mở tệp: chưa tìm thấy tệp trên server."
...
Function GetDataDescription(Val Handle) Export
	...
	If TypeOf(Handle) = Type("XDTODataObject") Then
		...
		StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en=', added: %1 (%2), it is recommended to import: %3 (%2)';ru=', добавлен: %1 (%2), рекомендовано загрузить: %3 (%2)';vi=', đã bổ sung: %1 (%2), nên kết nhập: %3 (%2)'"), 
	...
	Else
		...
		Definition = Definition + 
		StringFunctionsClientServer.SubstituteParametersInString(
			NStr("en=', added: %1 (%2)';ru=', добавлен: %1 (%2)';vi=', đã bổ sung: %1 (%2)'"), 
