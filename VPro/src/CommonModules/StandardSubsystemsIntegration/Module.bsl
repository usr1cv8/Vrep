...
// See PropertiesManagementOverridable.ПриСозданииПредопределенныхНаборовСвойств.
Procedure OnGetPredefinedPropertySets(SetTree) Export
	
	UsersService.OnGetPredefinedPropertySets(SetTree);
	
	If CommonUse.SubsystemExists("StandardSubsystems.Interactions") Then
		ModuleInteractions = CommonUse.CommonModule("Interactions");
		ModuleInteractions.OnGetPredefinedPropertySets(SetTree);
	EndIf;
	...
	If CommonUse.SubsystemExists("StandardSubsystems.PersonalDataProtection") Then
		...
		PersonalDataProtectionModule.OnGetPredefinedPropertySets(SetTree);
	EndIf;
	
	If CommonUse.SubsystemExists("StandardSubsystems.FileOperations") Then
		ModuleFileOperationsService = CommonUse.CommonModule("FileOperationsService");
		ModuleFileOperationsService.OnGetPredefinedPropertySets(SetTree);
	EndIf;
	
//	If ИнтеграцияПодсистемБСППовтИсп.ПодпискиБТС().OnGetPredefinedPropertySets Then
//		МодульИнтеграцияПодсистемБТС = CommonUse.CommonModule("ServiceTechnologyIntegrationWithSSL");
//		МодульИнтеграцияПодсистемБТС.OnGetPredefinedPropertySets(SetTree);
//	EndIf;
//	
//	If ИнтеграцияПодсистемБСППовтИсп.ПодпискиБИП().OnGetPredefinedPropertySets Then
//		МодульИнтеграцияПодсистемБИП = CommonUse.CommonModule("ИнтеграцияПодсистемБИП");
//		МодульИнтеграцияПодсистемБИП.OnGetPredefinedPropertySets(SetTree);
//	EndIf;
