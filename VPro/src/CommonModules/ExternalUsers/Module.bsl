...
"установлен для нескольких внешних пользователей.';vi='Lỗi trong cơ sở dữ liệu:"
"Đối tượng đăng nhập ""%1"" (%2)"
"đã thiết lập đối với nhiều người sử dụng ngoài.'"),
				AuthorizationObject,
...
"в базе данных: Для внешнего пользователя ""%1"" не задан объект авторизации.';vi='Lỗi"
"trong cơ sở dữ liệu: Đối với người sử dụng ngoài ""%1"" chưa đặt đối tượng đăng nhập.'"),
			ExternalUser);
	EndIf;
