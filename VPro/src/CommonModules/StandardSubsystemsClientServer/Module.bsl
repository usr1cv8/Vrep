...
Function CellsAmount(SpreadsheetDocument, SelectedAreas) Export
	...
	If SelectedAreas = Undefined Then
		...
		#Else
			Return NStr("en='Value of the SelectedAreas parameter is not specified.';ru='Не указано значение параметра ""ВыделенныеОбласти"".';vi='Chưa chỉ ra giá trị tham số ""SelectedAreas"".'");
		#EndIf
	EndIf;
