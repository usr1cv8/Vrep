...
Function SubsystemDescription(LanguageCode) Export
	Return NStr("en='Report variants';ru='Варианты отчетов';vi='Phương án báo cáo'", ?(LanguageCode = Undefined, CommonUseClientServer.MainLanguageCode(), LanguageCode));
EndFunction

// Presentation of the importance group.
Function PresentationSeeAlso() Export
	Return NStr("en='See also';ru='См также';vi='Xem thêm'");
EndFunction 

// Presentation of the importance group.
Function PresentationImportant() Export
	Return NStr("en='Important';ru='Важный';vi='Quan trọng'");
EndFunction
