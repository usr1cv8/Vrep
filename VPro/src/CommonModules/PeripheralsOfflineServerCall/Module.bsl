...
Function WhenImportingReportAboutRetailSales(Device, ArrayOfData) Export
	...
	ReportAboutRetailSalesObject.Comment        = NStr("en='It is imported from offline cash register:';ru='Загружено из ККМ Offline:';vi='Kết nhập từ quầy thu ngân Offline:'") + " " + Device;
...
Procedure ScheduledJobUpdateGoodsCodes() Export
	...
	WriteLogEvent(NStr("en='Update goods codes of offline peripherals';ru='Обновление кодов товаров подключаемого оборудования Offline';vi='Cập nhật mã hàng hóa thiết bị bán hàng Offline'"),
	                         EventLogLevel.Information, , ,
	                         NStr("en='Scheduled update of goods codes of offline peripherals has been started.';ru='Начато регламентное обновление кодов товаров подключаемого оборудования Offline.';vi='Bắt đầu cập nhật thường kỳ mã hàng của thiết bị bán hàng Offline.'"));
	...
	While Selection.Next() Do
		...
		Except
			WriteLogEvent(NStr("en='Update goods codes of offline peripherals';ru='Обновление кодов товаров подключаемого оборудования Offline';vi='Cập nhật mã hàng hóa thiết bị bán hàng Offline'"),
			                         EventLogLevel.Error, , ,
			                         NStr("en='An error occurred during the scheduled update of the Offline peripherals goods codes.';ru='Во время регламентного обновления кодов товаров подключаемого оборудования Offline произошла ошибка.';vi='Trong thời gian cập nhật thường kỳ mã hàng hóa của thiết bị bán hàng Offline đã xảy ra lỗi.'")
	...
	WriteLogEvent(NStr("en='Update goods codes of offline peripherals';ru='Обновление кодов товаров подключаемого оборудования Offline';vi='Cập nhật mã hàng hóa thiết bị bán hàng Offline'"),
	                         EventLogLevel.Information, , ,
	                         NStr("en='Scheduled update of goods codes of offline peripherals is completed.';ru='Закончено регламентное обновление кодов товаров подключаемого оборудования Offline.';vi='Kết thúc cập nhật thường kỳ mã hàng hóa của thiết bị bán hàng Offline.'"));
