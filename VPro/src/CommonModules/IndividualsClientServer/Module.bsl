...
Function SurnameInitialsOfIndividual(InitialsString = "", Surname = " ", Name = " ", Patronymic = " ") Export
	...
	If CountSubstrings > 3 Then
		...
		AdditionalPatronymicParts.Add(NStr("en='ogly';ru='оглы';vi='oglu'"));
		AdditionalPatronymicParts.Add(NStr("en='uly';ru='улы';vi='uly'"));
		AdditionalPatronymicParts.Add(NStr("en='uulu';ru='уулу';vi='uulu'"));
		AdditionalPatronymicParts.Add(NStr("en='qizy';ru='кызы';vi='qizy'"));
		AdditionalPatronymicParts.Add(NStr("en='gizi';ru='гызы';vi='gizi'"));
