...
Procedure MarkToDeleteSubjectNotes(Source, Cancel) Export
	...
	While Selection.Next() Do
		...
		Except
			...
			WriteLogEvent(NStr("en='User notes.Set deletion mark';ru='Заметки пользователя.Установка пометки удаления';vi='Đánh dấu người sử dụng. Đặt dấu xóa'", CommonUseClientServer.MainLanguageCode()),
