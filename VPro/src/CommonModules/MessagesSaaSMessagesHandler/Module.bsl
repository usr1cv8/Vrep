	...
	Try
		...
		Else
			...
			Raise StringFunctionsClientServer.SubstituteParametersInString(
				NStr("en='Cannot define the message channel handler in SaaS %1';ru='Не удалось определить обработчик канала сообщений в модели сервиса %1';vi='Không thể xác định hàm sự kiện kênh thông báo trong mô hình dịch vụ %1'"), MessageChannel);
