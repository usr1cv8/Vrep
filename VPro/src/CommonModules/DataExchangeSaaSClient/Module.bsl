...
Procedure OnStart(Parameters) Export
	...
	If ClientWorkParameters.ThisIsOfflineWorkplace Then
		...
		If ClientWorkParameters.SynchronizeDataWithApplicationInInternetOnWorkStart Then
			...
			ShowUserNotification(NStr("en='OffLine work';ru='Автономная работа';vi='Làm việc độc lập'"), "e1cib/app/DataProcessor.DataExchangeExecution",
				NStr("en='It is recommended to synchronize data with the online application.';ru='Рекомендуется синхронизировать данные с приложением в Интернете.';vi='Cần đồng bộ hóa dữ liệu với ứng dụng trên Internet.'"), PictureLib.Information32);
...
" - доступно обновление приложения в Интернете.';vi='Trong nhiều trường hợp, việc đồng bộ hóa dữ liệu có thể mất nhiều thời gian:"
" - kênh kết nối chậm;"
" - khối lượng dữ liệu lớn;"
" - đang cập nhật ứng dụng trên Internet.'");

		WarningParameters.FlagText = NStr("en='Synchronize data with the online application';ru='Синхронизировать данные с приложением в Интернете';vi='Đồng bộ hóa dữ liệu với ứng dụng trên Internet'");
