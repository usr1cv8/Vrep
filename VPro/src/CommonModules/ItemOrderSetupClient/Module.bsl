...
"необходимо настроить сортировку списка по полю ""Порядок"". Настроить необходимую сортировку?';vi='Để thay đổi trình tự phần tử,"
"cần tùy chỉnh sắp xếp danh sách theo trường ""Trình tự"". Tùy chỉnh sắp xếp cần thiết?'");
