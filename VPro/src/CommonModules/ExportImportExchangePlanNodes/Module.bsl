...
"ExportImportExchangePlanNodes.BeforeObjectExport ()!';vi='Đối tượng metadata %1 không thể được xử lý bởi hàm sự kiện"
...
"ExportImportExchangePlanNodes.BeforeObjectImport()!';vi='Đối tượng metadata %1 không thể được xử lý bởi hàm sự kiện"
